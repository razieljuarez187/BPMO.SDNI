...
{
    /// <summary>
    /// Presentador aplicable para la gestión de las peticiones de una vista de Reporte de Porcentaje Utilización de Renta Diaria
    /// </summary>
    public class PorcentajeUtilizacionRDPRE
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private static readonly string nombreClase = typeof(PorcentajeUtilizacionRDPRE).Name;
        #endregion
        ...
        /// </summary>
        private IPorcentajeUtilizacionRDVIS vista;
        ...
        public PorcentajeUtilizacionRDPRE(IPorcentajeUtilizacionRDVIS vista)
        {
            try
            {               
                this.vista = vista;
