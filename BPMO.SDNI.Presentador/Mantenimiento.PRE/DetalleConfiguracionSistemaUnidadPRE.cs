...
namespace BPMO.SDNI.Mantenimiento.PRE {
    ...
    /// <summary>
    /// Presentador aplicable para la gestión de las peticiones de la Vista Detalle Configuraciones Sistemas de Unidad Idealease.
    /// </summary>
    public class DetalleConfiguracionSistemaUnidadPRE {
        ...
        private IDetalleConfiguracionSistemaUnidadVIS vista;

        /// <summary>
        /// Nombre de la clase en curso.
        /// </summary>
        private readonly string nombreClase = typeof(DetalleConfiguracionSistemaUnidadPRE).Name;
        ...
        public DetalleConfiguracionSistemaUnidadPRE(IDetalleConfiguracionSistemaUnidadVIS vista) {
            this.vista = vista;
        ...
        /// <summary>
        /// Verifica que el Usuario logueado tenga los permisos para realizar la acción Detalle Configuración Sistema de Unidad.
        /// </summary>
        ...
        private void EstablecerSeguridad() { 
            try {
                ...
                //Se valida si el usuario tiene permiso para Detalle Configuración Sistema de Unidad
                if (!ExisteAccion(acciones, "CONSULTAR") || !ExisteAccion(acciones, "UI ACTUALIZAR"))
