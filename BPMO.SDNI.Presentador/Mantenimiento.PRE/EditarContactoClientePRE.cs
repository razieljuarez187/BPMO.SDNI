...
namespace BPMO.SDNI.Mantenimiento.PRE {
    ...
    /// <summary>
    /// Presentador aplicable para la gestión de las peticiones de la Vista Editar Contactos Clientes Idealease.
    /// </summary>
    public class EditarContactoClientePRE {
        ...
        /// </summary>
        private IEditarContactoClienteVIS vista;
        ...
        /// </summary>
        private readonly string nombreClase = typeof(EditarContactoClientePRE).Name;
        ...
        public EditarContactoClientePRE(IEditarContactoClienteVIS vista) {
            this.vista = vista;
        ...
        /// <summary>
        /// Verifica que el Usuario logueado tenga los permisos para realizar la acción de Editar Contactos Clientes Idealease.
        /// </summary>
        ...
        private void EstablecerSeguridad() { 
            try {
                ...
                //Se valida si el usuario tiene permiso para Editar Contacto Cliente Idealease
        ...
        public void Guardar() {
            ...
            try{ 
                ctrlContactoCliente.Actualizar(dataContext, vista.ContactoClienteSeleccionado, getSeguridad());
