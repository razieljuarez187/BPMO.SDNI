...
namespace BPMO.SDNI.Mantenimiento.PRE {
    ...
    /// <summary>
    /// Presentador aplicable para la gestión de las peticiones de la Vista Editar Configuraciones Sistemas de Unidad Idealease.
    /// </summary>
    public class EditarConfiguracionSistemaUnidadPRE {
        ...
        private IEditarConfiguracionSistemaUnidadVIS vista;

        /// <summary>
        /// Nombre de la clase en curso.
        /// </summary>
        private readonly string nombreClase = typeof(EditarConfiguracionSistemaUnidadPRE).Name;
        ...
        public EditarConfiguracionSistemaUnidadPRE(IEditarConfiguracionSistemaUnidadVIS vista) {
            this.vista = vista;
        ...
        /// <summary>
        /// Verifica que el Usuario logueado tenga los permisos para realizar la acción de Editar Configuracion Sistema de Unidad.
        /// </summary>
        ...
        private void EstablecerSeguridad() { 
            try {
                ...
                //Se valida si el usuario tiene permiso para Editar Configuracion Sistema de Unidad
        ...
        /// <summary>
        /// Realiza la Edición de la Configuración Sistema de Unidad Idealease seleccionada. Verifica que no exista 
        ...
        public void Editar() {
            ...
            try{
                ctrlConfiguracion.Actualizar(dataContext, vista.ConfiguracionSeleccionada, getSeguridad());        
        ...
        /// <summary>
        /// Verifica que no existan una Configuración Sistema de Unidad Idealease con la misma Clave al Editar.
        /// </summary>
        /// <returns>Retorna True si encontro resultados, en caso contrario retorna False.</returns>
        private bool Validar() {
            if (!vista.ConfiguracionSeleccionada.Activo.Value)
                return false;
