...
{
    /// <summary>
    /// Presentador para la vista que visualiza la información de la cabezera de una factura
    /// </summary>
    public class ucInformacionCabeceraPRE
    {
        #region Atributos
        /// <summary>
        ...
        /// </summary>
        private IucInformacionCabeceraVIS vista;

        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private string nombreClase = "ucInformacionCabeceraPRE";
