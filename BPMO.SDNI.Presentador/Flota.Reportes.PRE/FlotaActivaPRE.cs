...
namespace BPMO.SDNI.Flota.Reportes.PRE {
      /// <summary>
    /// Presentador que gestiona las peticiones de una Vista de Reporte de Flota Activa  Registrados
    /// </summary>
    public class FlotaActivaPRE {
         #region Constantes
        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private static readonly string nombreClase = typeof(FlotaActivaPRE).Name;
        #endregion
        ...
        /// </summary>
        private IFlotaActivaVIS vista;

        /// <summary>
        /// Controlador de Consulta de configuración de alerta
        /// </summary>
        private FlotaActivaBR controlador;
        #endregion       
        ...
        public FlotaActivaPRE(IFlotaActivaVIS vista){
            try
            {
                this.vista = vista;
                this.dctx = FacadeBR.ObtenerConexion();
                this.controlador = new FlotaActivaBR();
            }
            catch (Exception ex)
            {
