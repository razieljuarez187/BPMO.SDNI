...
namespace BPMO.SDNI.Contratos.PSL.PRE {
    /// <summary>
    /// Presentador de la Edición del Contrato PSL
    /// </summary>
    public class EditarContratoROPRE {
        #region Atributos
        /// <summary>
        ...
        /// Vista de la Edición
        /// </summary>
        private IEditarContratoROVIS vista;
        /// <summary>
        ...
        /// Nombre de la Clase
        /// </summary>
        private string nombreClase = "EditarContratoROPRE";
        #endregion
        ...
        public EditarContratoROPRE(IEditarContratoROVIS view, IucContratoPSLVIS viewDatosContrato, IucCatalogoDocumentosVIS viewDocumentos, IucHerramientasPSLVIS viewHerramientas, IucLineaContratoPSLVIS viewLineas) {
            try {
                this.vista = view;
        ...
        public void EditarBorrador() {
            ...
            this.Editar();
            ContratoPSLBO contratoGuardado = (ContratoPSLBO)this.vista.UltimoObjeto;

            this.LimpiarSesion();
            this.vista.LimpiarPaqueteNavegacion("UltimoContratoPSLBO");
            this.vista.EstablecerPaqueteNavegacion("ContratoPSLBO", contratoGuardado);
            this.vista.RedirigirADetalles();
        }
        /// <summary>
        ...
        private void Editar() {
            ...
            try {
                ...
                if (this.vista.EstatusID == (int)EEstatusContrato.EnPausa) {
                    #region LLenar el anexo por contrato.
        ...
        private object InterfazUsuarioADato() {
            ...
            foreach (LineaContratoPSLBO linea in this.vista.LineasContrato) {
                ...
                if (linea.Cobrable != null) {lineaBO.Cobrable = new TarifaContratoPSLBO
                    {
