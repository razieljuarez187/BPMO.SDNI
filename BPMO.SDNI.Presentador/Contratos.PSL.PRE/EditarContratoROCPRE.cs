...
namespace BPMO.SDNI.Contratos.PSL.PRE {
    /// <summary>
    /// Presentador de la Edición del Contrato ROC PSL
    /// </summary>
    public class EditarContratoROCPRE {
        #region Atributos
        /// <summary>
        ...
        /// Vista de la Edición
        /// </summary>
        private IEditarContratoROCVIS vista;
        /// <summary>
        ...
        /// Nombre de la Clase
        /// </summary>
        private string nombreClase = "EditarContratoROCPRE";
        #endregion
        ...
        public EditarContratoROCPRE(IEditarContratoROCVIS view, IucContratoPSLVIS viewDatosContrato, IucCatalogoDocumentosVIS viewDocumentos, IucHerramientasPSLVIS viewHerramientas, IucLineaContratoPSLVIS viewLineas) {
            try {
                this.vista = view;
                ...
                this.vista.MostrarMensaje("Inconsistencia en los parámetros de configuración", ETipoMensajeIU.ERROR, this.nombreClase + ".EditarContratoROCPRE:" + ex.Message);
            }
        }
        #endregion
        ...
        /// </summary>
        public void RealizarPrimeraCarga(bool lEditarEnCurso) {
            try {
                this.EstablecerDatosNavegacion(this.vista.ObtenerPaqueteNavegacion("UltimoContratoPSLBO"));
                if (lEditarEnCurso) {
                    this.presentadorDatosContrato.AsignarModoRegistro("EDEC");
                }
                this.PrepararEdicion(lEditarEnCurso);
        ...
        private void EstablecerDatosNavegacion(object paqueteNavegacion) {
            try {
                ...
                if (!(paqueteNavegacion is ContratoPSLBO))
                    throw new Exception("Se esperaba un Contrato de Renta con Opción a Compra.");
        ...
        /// </summary>
        private void PrepararEdicion(bool lEditarEnCurso) {
            this.vista.PrepararEdicion();
            this.presentadorDatosContrato.PrepararEdicion();
            this.presentadorDocumentos.ModoEditable(!lEditarEnCurso);
            this.presentadorHerramientas.Inicializar();
            if (lEditarEnCurso) {
                this.vista.PrepararEdicion(true);
            }
        }
        ...
        /// <summary>
        /// Actualiza la Edición del Contrato en Borrador
        /// </summary>
        ...
        public void EditarTerminada() {
            ...
            if (this.vista.EstatusID != null) {
                if (this.vista.EstatusID == (int)EEstatusContrato.Borrador)
        ...
        private void Editar() {
            ...
            try {
                ...
                #region Parametros RPT
                Dictionary<string, object> dataSources = new Dictionary<string, object>();
                dataSources["ContratoPSLBO"] = bo;

                #region Configuraciones de la unidad operativa
                ...
                if (lstConfigUO.Any())
                    dataSources.Add("RepresentanteEmpresa", lstConfigUO[0]);
                #endregion

                #region Consulta periodoTarifario
                string monedaCodigo = bo.Divisa.MonedaDestino.Codigo;
                ...
                #region Número de Anexo
                if (bo.AnexosContrato != null && bo.AnexosContrato.Any())
                    dataSources.Add("NumeroAnexo", bo.AnexosContrato.Count + 1);
                #endregion
                #endregion

                if (this.vista.EstatusID == (int)EEstatusContrato.EnPausa) {
                ...
                if (this.vista.EstatusID == (int)EEstatusContrato.EnCurso) {
                    #region LLenar el anexo por cambios en la renovación.
                    AnexosContratoPSLBO anexo = new AnexosContratoPSLBO();
                    anexo.FechaInicio = bo.FechaInicioActual;
                    anexo.FechaFin = bo.FechaPromesaActual;
                    anexo.FechaIntercambioUnidad = null;
                    anexo.MontoTotalArrendamiento = bo.MontoTotalArrendamiento;
                    anexo.TipoAnexoContrato = ETipoAnexoContrato.Modificacion;
                    anexo.Vigente = true;
                    anexo.ContratoPSLID = this.vista.ContratoID;
                    anexo.FC = this.vista.FUA;
                    anexo.FUA = this.vista.FUA;
                    ...
                    #region Creando el pago por modificación
                    GeneradorPagoPSLBR generadorPago = new GeneradorPagoPSLBR();
                    //Cuando se genera el pago se llenan los campos de acumulados de tarifas
                    generadorPago.GenerarPagos(this.dctx, bo, (ContratoPSLBO)this.vista.UltimoObjeto, seguridadBO, 2, true);
                    #endregion
                }
        ...
        private object InterfazUsuarioADato() {
            ...
            bo.MontoTotalArrendamiento = this.presentadorDatosContrato.Vista.MontoTotalArrendamiento;
            bo.FechaPagoRenta = this.presentadorDatosContrato.Vista.FechaPagoRenta;
            bo.Plazo = this.presentadorDatosContrato.Vista.Plazo;
            bo.InversionInicial = this.presentadorDatosContrato.Vista.InversionInicial;
            #endregion
        ...
        private void DatoAInterfazUsuario(object obj) {
            ...
            if (bo.FechaInicioArrendamiento != null && bo.FechaPromesaDevolucion != null)
            ...
            #region Seccion de ROC
            this.presentadorDatosContrato.Vista.MontoTotalArrendamiento = bo.MontoTotalArrendamiento;
            this.presentadorDatosContrato.Vista.FechaPagoRenta = bo.FechaPagoRenta;
            this.presentadorDatosContrato.Vista.Plazo = bo.Plazo;
            this.presentadorDatosContrato.Vista.InversionInicial = bo.InversionInicial;
            #endregion
