...
namespace BPMO.SDNI.Contratos.PSL.PRE {
    ...
    /// </summary>
    public class DetalleContratoROCPRE {
        #region Atributos
        /// <summary>
        ...
        /// </summary>
        private IDetalleContratoROCVIS vista;
        /// <summary>
        ...
        /// Nombre de la Clase
        /// </summary>
        private string nombreClase = "DetalleContratoROCPRE";
        ...
        public DetalleContratoROCPRE(IDetalleContratoROCVIS view, IucContratoPSLVIS viewDatosContrato, IucCatalogoDocumentosVIS viewDocumentos, IucLineaContratoPSLVIS viewLineas, IucHerramientasPSLVIS vistaHerramientas) {
            try {
                this.vista = view;
        ...
        private object InterfazUsuarioADato() {
            ...
            bo.Tipo = ETipoContrato.ROC;//Se deberá cambiar para que su valor lo tome del tipo de las unidades
            ...
            if (this.presentadorDatosContrato.Vista.ClienteID != null)
                bo.Cliente.Cliente.Id = this.presentadorDatosContrato.Vista.ClienteID;
        ...
        private void DatoAInterfazUsuario(IDictionary parameters) {
            ...
            if (lstSuc.Any()) {
                ...
                if (lstSuc.Any()) {
                    if (lstSuc[0].DireccionesSucursal != null && lstSuc[0].DireccionesSucursal.Any())
                        this.presentadorDatosContrato.Vista.DomicilioEmpresa = lstSuc[0].DireccionesSucursal[0].Calle;
                }
            }
            #endregion
            ...
            if (bo.RepresentantesLegales != null) {
                this.presentadorDatosContrato.Vista.RepresentantesSeleccionados = bo.RepresentantesLegales.ConvertAll(a => (RepresentanteLegalBO)a);
                this.presentadorDatosContrato.Vista.ActualizarRepresentantesLegales();
            }
            if (bo.Avales != null) {
                this.presentadorDatosContrato.Vista.AvalesSeleccionados = bo.Avales.ConvertAll(a => (AvalBO)a);
                this.presentadorDatosContrato.Vista.ActualizarAvales();
            }
            ...
            this.presentadorDatosContrato.Vista.RepresentanteEmpresa = lstConfigUO[0].Representante;
            #endregion
            ...
            if (bo.Cliente != null) {
                ...
                this.presentadorDatosContrato.Vista.ClienteEsFisica = bo.Cliente.Cliente.Fisica;
        ...
        /// </summary>
        public void ImprimirContratoROC() {
            try {
                //ContratoPSLBO bo = (ContratoPSLBO)this.InterfazUsuarioADato();
                this.LimpiarSesion();
                ...
                this.vista.EstablecerPaqueteNavegacionReporte("ContratoROC", datos);
        ...
        public void RealizarPrimeraCarga() {
            try {
                ...
                this.presentadorDatosContrato.Vista.EstablecerOpcionesMoneda(lstMonedas.ToDictionary(p => p.Codigo, p => p.Nombre));
                this.ConsultarCompleto();

                this.CalcularTotales();
                //RQM. 15003, barra de herramientas.
        ...
        private void ConsultarCompleto() {
            ...
            try {
                ...
                parameters["ContratoPSLBO"] = lst[0];
                this.DatoAInterfazUsuario(parameters);
        ...
        public List<ContratoPSLBO> ConsultarCompletoPRE() {
            try {
                ...
                List<ContratoPSLBO> lst = this.controlador.ConsultarCompleto(this.dctx, bo);
                return lst;
        ...
        /// <summary>
        /// Imprime el pagare de contrato
        /// </summary>
        public void ImprimirPagareROC() {
            try {
                this.LimpiarSesion();
