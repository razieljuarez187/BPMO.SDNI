...
namespace BPMO.SDNI.Contratos.PSL.PRE {
    ...
    /// </summary>
    public class RenovarContratoROCPRE {
        #region Atributos
        /// <summary>
        ...
        /// Vista de la Edición
        /// </summary>
        private IRenovarContratoROCVIS vista;
        /// <summary>
        ...
        /// Nombre de la Clase
        /// </summary>
        private string nombreClase = "RenovarContratoROCPRE";
        #endregion
        ...
        public RenovarContratoROCPRE(IRenovarContratoROCVIS view, IucContratoPSLVIS viewDatosContrato, IucCatalogoDocumentosVIS viewDocumentos, IucHerramientasPSLVIS viewHerramientas, IucLineaContratoPSLVIS viewLineas) {
            try {
                this.vista = view;
        ...
        private void EstablecerDatosNavegacion(object paqueteNavegacion) {
            try {
                ...
                if (!(paqueteNavegacion is ContratoPSLBO))
                    throw new Exception("Se esperaba un Contrato ROC.");
        ...
        private void Renovar() {
            ...
            try {
                ...
                #region Consulta periodoTarifario. // eliminado
