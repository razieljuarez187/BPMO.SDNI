...
namespace BPMO.SDNI.Contratos.PSL.PRE {
    ...
    /// </summary>
    public class RegistrarContratoROPRE {
        #region Atributos
        /// <summary>
        ...
        /// </summary>
        private IRegistrarContratoROVIS vista;
        /// <summary>
        ...
        /// Nombre de la Clase
        /// </summary>
        private string nombreClase = "RegistrarContratoROPRE";
        #endregion
        ...
        /// </summary>
        private ContratoPSLBO Registrar() {
        ...
        private object InterfazUsuarioADato() {
            ...
            bo.Operador = new OperadorBO() { Direccion = new DireccionPersonaBO() { Ubicacion = new UbicacionBO() { 
            ...
            bo.Cliente.Cliente.RFC = vista.ClienteRFC;
            bo.Cliente.Cliente.Fisica = vista.ClienteEsFisica;
            bo.Cliente.Numero = vista.CuentaClienteNumeroCuenta;
                    ...
                    if (presentadorDatosContrato.Vista.UnidadID != null) {
                        if (!presentadorDatosContrato.ExisteUnidadContrato(new UnidadBO { UnidadID = presentadorDatosContrato.Vista.UnidadID })) {
                            if (presentadorDatosContrato.Vista.CodigoMoneda != null) {
                                ...
                                unidad.Sucursal = new SucursalBO { UnidadOperativa = new UnidadOperativaBO { Id = vista.UnidadOperativaID } };
