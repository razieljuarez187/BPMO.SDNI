...
namespace BPMO.SDNI.Contratos.PSL.Reportes.PRE {
    /// <summary>
    /// Presentador usado para el reporte general de rentas RO/RE/ROC
    /// </summary>
    public class RentaGeneralPSLPRE {
                #region Constantes
        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private static readonly string nombreClase = typeof(RentaGeneralPSLPRE).Name;
        #endregion
        ...
        /// </summary>
        private IRentaGeneralPSLVIS vista;

        /// <summary>
        /// Controlador del reporte general de rentas
        /// </summary>
        private RentaGeneralPSLBR controlador;
        #endregion
        ...
        public RentaGeneralPSLPRE(IRentaGeneralPSLVIS vista)
        {
            try
            {
                this.vista = vista;
                this.dctx = FacadeBR.ObtenerConexion();
                this.controlador = new RentaGeneralPSLBR();
            }
            catch (Exception ex)
            {
