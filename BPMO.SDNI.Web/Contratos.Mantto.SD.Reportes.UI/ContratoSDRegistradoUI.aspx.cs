...
namespace BPMO.SDNI.Contratos.Mantto.SD.Reportes.UI
{
    /// <summary>
    /// Vista de consulta para el reporte de Contratos de Servicio Dedicado Registrados
    /// </summary>
    public partial class ContratoSDRegistradoUI : ReportPage, IContratosRegistradosManttoVIS
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase en curso
        /// </summary>
        private static readonly String nombreClase = typeof(ContratoSDRegistradoUI).Name;
        #endregion
