<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="AgregarDocumentosContratoUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.RD.UI.AgregarDocumentosContratoUI" %>
    ...
    <div id="PaginaContenido">
        <div style="display: block;">
            ...
            <div id="BarraUbicacion">
                <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - AGREGAR DOCUMENTOS CONTRATO DE RENTA DIARIA</asp:Label>
            </div>
