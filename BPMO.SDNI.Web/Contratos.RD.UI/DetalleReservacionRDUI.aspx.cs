...
{
    public partial class DetalleReservacionRDUI : System.Web.UI.Page, IDetalleReservacionRDVIS
    {
        #region Atributos
        /// <summary>
        /// Nombre de la clase en la cual estamos trabajando
        /// </summary>
        private string nombreClase = "DetalleReservacionRDUI";
        /// <summary>
        /// presentador del UC de información general del contrato de renta diaria
        /// </summary>
        private DetalleReservacionRDPRE presentador;
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                this.presentador = new DetalleReservacionRDPRE(this, this.ucReservacion);
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.RD.UI/EditarReservacionRDUI.aspx"));
        }
        ...
        public void PermitirEditar(bool permitir)
        {
            ...
            this.mReservacion.Items[1].Enabled = permitir;
        }
        public void PermitirCancelar(bool permitir)
        {
            this.mReservacion.Items[2].Enabled = permitir;
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MostrarMensaje("Inconsistencias al intentar editar la reservación", ETipoMensajeIU.ERROR, nombreClase + ".btnEditar_Click:" + ex.Message);
            }
        }
        protected void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MostrarMensaje("Inconsistencias al intentar cancelar la reservación", ETipoMensajeIU.ERROR, nombreClase + ".btnCancelar_Click:" + ex.Message);
            }
        }

        protected void mReservacion_MenuItemClick(object sender, System.Web.UI.WebControls.MenuEventArgs e)
        {
            try
            {
                switch (e.Item.Value)
                {
                    case "Editar":
                        ...
                        break;
                    case "Cancelar":
                        this.RegistrarScript("Cancelar", "confirmarCancelar();");
                        break;
                }
            }
            catch (Exception ex)
            {
                this.MostrarMensaje("Inconsistencias al intentar editar la reservación", ETipoMensajeIU.ERROR, nombreClase + ".mReservacion_MenuItemClick:" + ex.Message);
            }
        }
        #endregion
    }
