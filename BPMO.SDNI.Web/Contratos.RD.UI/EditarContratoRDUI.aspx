<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarContratoRDUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.RD.UI.EditarContratoRDUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - EDITAR CONTRATO DE RENTA DIARIA</asp:Label>
        </div>
    ...
    <asp:HiddenField ID="hdnLineaContratoID" runat="server" />
