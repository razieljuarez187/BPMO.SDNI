...
{
    public partial class ucResumenContratoRDUI : System.Web.UI.UserControl, IucResumenContratoRDVIS
    {
        #region Atributos
        ...
        /// </summary>
        internal ucResumenContratoRDPRE Presentador { get; set; }
        ...
        public DateTime? FechaContrato
        {
            ...
            set
            {
                txtFechaContrato.Text = (value != null) ? value.Value.ToString("dd/MM/yyyy  h:mm tt") : null;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Presentador = new ucResumenContratoRDPRE(this);
            }
            catch (Exception ex)
            {
