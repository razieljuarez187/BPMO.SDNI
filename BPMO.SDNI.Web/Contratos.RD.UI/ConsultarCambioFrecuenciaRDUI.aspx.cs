...
{
    public partial class ConsultarCambioFrecuenciaRDUI : System.Web.UI.Page, IConsultarCambioFrecuenciaRDVIS
    {
        #region Atributos
        /// <summary>
        /// Presentador de Consultar Contratos
        /// </summary>
        private ConsultarCambioFrecuenciaRDPRE presentador;

        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private static readonly string nombreClase = typeof(ConsultarCambioFrecuenciaRDUI).Name;
        ...
        /// </summary>
        public List<ContratoRDBO> ContratosConsultados
        {
            get
            {
                object contratos = Session["ContratosConsultados"];
                if(contratos != null)
                    return (List<ContratoRDBO>)contratos;
                return null;
            }
            set
            {
                if(value != null) Session["ContratosConsultados"] = value;
                else
                    Session.Remove("ContratosConsultados");
            }
        }
        #endregion
        #region Metodos
        ...
        {
            this.Session.Remove("ContratosConsultados");
        }
        /// <summary>
        ...
        {
            const string Url = "CambiarFrecuenciaContratosRDUI.aspx";
        ...
        public void PresentarResultadoConsulta(List<ContratoRDBO> contratos)
        {
            ContratosConsultados = contratos;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                presentador = new ConsultarCambioFrecuenciaRDPRE(this);
                if(!IsPostBack)
                {
        ...
        protected void grdContratos_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                grdContratos.DataSource = ContratosConsultados;
        ...
        protected void grdContratos_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    ContratoRDBO contrato = (ContratoRDBO)e.Row.DataItem;
                    ...
                    Label lblFechaContrato = e.Row.FindControl("lblFechaInicio") as Label;
                    ...
                    Label lblFechaPromesa = e.Row.FindControl("lblFechaPromesa") as Label;
                    if(lblFechaPromesa != null)
                    {
                        string fecha = string.Empty;
                        if(contrato.FechaPromesaDevolucion != null)
                        {
                            fecha = String.Format("{0:dd/MM/yyyy}", contrato.FechaPromesaDevolucion);
                        }
                        lblFechaPromesa.Text = fecha;
                    }
                    ...
                    if(lblFrecuencia != null)
                    {
                        ...
                        if(contrato.FrecuenciaFacturacion != null)
                        {
                            frecuencia = contrato.FrecuenciaFacturacion.ToString().ToUpper();
                        }
