<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarTarifaRDUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.RD.UI.EditarTarifaRDUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label runat="server" ID="lblEncabezadoLeyenda">CAT&Aacute;LOGOS - ACTUALIZAR TARIFA</asp:Label>
        </div>
        <!--Menú secundario-->
        ...
        <div id="divInformacionGeneral" class="GroupBody">
            ...
            <fieldset id="fsInformacionGeneral">
                ...
                <table class="trAlinearDerecha">
                    ...
                    <asp:Panel runat="server" ID="pnlDatosCliente">
                        <tr>
                            <td class="tdCentradoVertical" style="width: 150px;">Cliente</td>
                            <td style="width: 20px;">&nbsp;</td>
                            <td class="tdCentradoVertical" style="width: 320px;">
                            ...
                            <td style="width: 20px;">&nbsp;</td>
                            <td class="tdCentradoVertical" style="width: 280px;">
                                <asp:TextBox runat="server" ID="txtVigencia" CssClass="CampoFecha" Enabled="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tdCentradoVertical" colspan="4">
                                <asp:TextBox runat="server" ID="txtObservaciones" Width="250px" TextMode="MultiLine" 
                                    style="max-width: 250px; min-width: 250px; max-height: 90px; min-height: 90px;" Enabled="True"></asp:TextBox>
                            </td>
                        </tr>
                    </asp:Panel>
                </table>
            ...
            <fieldset id="fsInfoSistema">
                <legend>Informacion del Sistema</legend>
                <table class="trAlinearDerecha">
                    <tr>
