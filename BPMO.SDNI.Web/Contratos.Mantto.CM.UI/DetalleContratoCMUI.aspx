<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="DetalleContratoCMUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.CM.UI.DetalleContratoCMUI" %>
...
<%@ Register tagprefix="uc" TagName="ucHerramientasCMUI" Src="ucHerramientasCMUI.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - DETALLE CONTRATO DE MANTENIMIENTO</asp:Label>
        </div>
