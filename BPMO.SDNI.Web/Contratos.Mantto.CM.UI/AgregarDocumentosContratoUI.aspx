<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="AgregarDocumentosContratoUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.CM.UI.AgregarDocumentosContratoUI" %>
    ...
    <div id="PaginaContenido">
        <div style="display: block;">
            ...
            <div id="BarraUbicacion">
                <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - AGREGAR DOCUMENTOS CONTRATO DE MANTENIMIENTO</asp:Label>
            </div>
            ...
            <div style="height: 80px;">
                ...
                <ul id="MenuSecundario" style="float: left; height: 64px;">
                    <li class="MenuSecundarioSeleccionado">
                        <asp:HyperLink ID="hlkConsulta" runat="server" NavigateUrl="~/Contratos.Mantto.CM.UI/ConsultarContratoCMUI.aspx">
                            CONSULTAR C.M.
