...
{
    public partial class ConsultarContratoCMUI : System.Web.UI.Page, IConsultarContratoManttoVIS
    {
        #region Atributos
        ...
        /// </summary>
        private string nombreClase = "ConsultarContratoCMUI";
        ...
        {
            get { return Session["ContratosEncontradosCM"] as List<ContratoManttoBOF>; }
        }
        ...
        public List<object> SucursalesAutorizadas
        {
            get
            {
                if (Session["SucursalesAutCM"] != null)
                    return Session["SucursalesAutCM"] as List<object>;
                else
                {
            ...
            set { Session["SucursalesAutCM"] = value; }
        }
        ...
        {
            Session["ContratosEncontradosCM"] = resultado;
        ...
        {
            if (Session["ContratosEncontradosCM"] != null)
                Session.Remove("ContratosEncontradosCM");
            Session.Remove("SucursalesAutCM");
        }
        /// <summary>
