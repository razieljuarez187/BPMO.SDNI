<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="CancelarContratoCMUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.CM.UI.CancelarContratoCMUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - CANCELAR CONTRATO DE MANTENIMIENTO</asp:Label>
        </div>
