<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarContratoCMUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.CM.UI.RegistrarContratoCMUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - REGISTRAR CONTRATO DE MANTENIMIENTO</asp:Label>
        </div>
