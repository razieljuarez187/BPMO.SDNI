...
// Satisface a la Solución de la R0005
using System;
...
{
    public partial class CerrarContratoCMUI : System.Web.UI.Page, ICerrarContratoManttoVIS
    {
        #region Atributos
        /// <summary>
        /// Nombre  de la clase para agregar a los mensajes de Error
        /// </summary>
        private const string nombreClase = "CerrarContratoCMUI";
        ...
        /// <summary>
        /// Obtiene o establece las observaciones de cierre del contrato
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece la fecha de cierre del contrato
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el motivo de cierre
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new CerrarContratoManttoPRE(this, this.ucHerramientas, this.ucContratoUI, this.ucContratoUI);
        ...
        {
            Response.Redirect(ResolveUrl("~/Contratos.Mantto.CM.UI/DetalleContratoCMUI.aspx"), true);
        }
