...
{
    /// <summary>
    /// Vista de consulta para el Reporte de Porcentaje de utilización de Renta Diaria de Refrigerados por Tipo
    /// </summary>
    public partial class PorcentajeUtilizacionRDRefrigeradosTipoUI : ReportPage, IPorcentajeUtilizacionRDVIS
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase en curso
        /// </summary>
        private static readonly String nombreClase = typeof(PorcentajeUtilizacionRDRefrigeradosTipoUI).Name;
        #endregion
        ...
        {
            get { return ETipoEquipoAliado.Refrigerado; }
        }
        #endregion
