...
{
    /// <summary>
    /// Vista de consulta para el Reporte de Porcentaje de utilización de Renta Diaria de Refrigerados
    /// </summary>
    public partial class PorcentajeUtilizacionRDRefrigeradosUI :  ReportPage, IPorcentajeUtilizacionRDVIS
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase en curso
        /// </summary>
        private static readonly String nombreClase = typeof(PorcentajeUtilizacionRDRefrigeradosUI).Name;
        #endregion
