...
{
    /// <summary>
    /// Vista de consulta para el Reporte de Porcentaje de utilización de Renta Diaria por Sucursal
    /// </summary>
    public partial class PorcentajeUtilizacionRDUI : ReportPage, IPorcentajeUtilizacionRDVIS
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase en curso
        /// </summary>
        private static readonly String nombreClase = typeof(PorcentajeUtilizacionRDUI).Name;
        #endregion
