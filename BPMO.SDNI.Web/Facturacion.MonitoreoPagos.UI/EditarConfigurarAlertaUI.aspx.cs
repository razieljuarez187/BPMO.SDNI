...
{
    /// <summary>
    /// Forma que realiza el proceso de editar de un registro
    /// </summary>
    public partial class EditarConfigurarAlertaUI : System.Web.UI.Page, IEditarConfigurarAlertaVIS
    {
        #region Atributos
        ...
        /// </summary>
        private EditarConfigurarAlertaPRE presentador;

        /// <summary>
        /// Nombre de la clase para agregar a los mensajes de Error
        /// </summary>
        private const string nombreClase = "EditarConfigurarAlertaUI";
        ...
        {
            this.ucConfigurarAlerta.PrepararEdicion();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                this.presentador = new EditarConfigurarAlertaPRE(this, this.ucConfigurarAlerta);
        ...
        /// <summary>
        /// Evento que se ejecuta cuando se solicita  la cancelación de la edición
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MostrarMensaje("Inconsistencia al cancelar la edición", ETipoMensajeIU.ERROR, nombreClase + ".btnCancelar_Click:" + ex.GetBaseException().Message);
            }
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MostrarMensaje("Inconsistencia al realizar la edición del operador", ETipoMensajeIU.ERROR, nombreClase + ".btnGuardar_Click:" + ex.GetBaseException().Message);
            }
        }
        #endregion        
    }
