<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="CambiarSucursalUnidadUI.aspx.cs" Inherits="BPMO.SDNI.Flota.UI.CambiarSucursalUnidadUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        /*Estilos de sucursal*/
        .ContenedorMovimiento fieldset { width: 100%; margin-right: auto; margin-left: auto; float: none; display: inherit; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">FLOTA - CAMBIAR UNIDAD DE SUCURSAL</asp:Label>
        </div>
        ...
        <div style="height: 65px;">
            ...
            <div id="BarraHerramientas">
                <asp:Menu runat="server" ID="mFlota" IncludeStyleBlock="False" Orientation="Horizontal"
                    ...
                    <Items>
                        <asp:MenuItem Text="Expediente" Value="Expediente" Selected="false" Selectable="False"
        ...
        <div id="DatosCatalogo" class="GroupBody">
            <div id="EncabezadoDatosCatalogo" class="GroupHeader">
                <span>CAMBIAR UNIDAD DE SUCURSAL</span>
            ...
            <div id="ControlesDatos">
                <div class="ContenedorMovimiento">
                        ...
                        <table class="trAlinearDerecha" style="width: 690px; margin: 0px auto">
                            <tr>
                                ...
                                <td class="tdCentradoVertical" style="width: 275px;">
                                    <asp:HiddenField runat="server" ID="hdnSucursalActualID" />
                                    <asp:TextBox ID="txtSucursalActual" runat="server" Width="240px" MaxLength="80" Enabled="False"></asp:TextBox>
                                </td>
                                <td class="tdCentradoVertical" style="text-align: right;">Empresa</td>
                                <td style="width: 5px;">&nbsp;</td>
                                <td class="tdCentradoVertical">
                                    <asp:TextBox ID="txtEmpresaActual" runat="server" Width="240px" Enabled="false"></asp:TextBox>
                                    <asp:HiddenField runat="server" ID="hdnEmpresaActualID" />
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top: 5px; text-align: right; width: 75px;">Domicilio</td>
                                <td style="width: 5px;">&nbsp;</td>
                                <td class="tdCentradoVertical" colspan="4">
                                    <asp:TextBox ID="txtDomicilioSucursalActual" runat="server" Rows="5" Columns="30"
                                        TextMode="MultiLine" Enabled="false" MaxLength="500" Style="float: left; max-width: 590px;
                                        min-width: 590px; max-height: 40px; min-height: 40px;"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    ...
                    <fieldset>
                        <legend>Sucursal Nueva</legend>
                        <table class="trAlinearDerecha" style="width: 690px; margin: 0px auto">
                            <tr>
                                <td class="tdCentradoVertical" style="width: 75px;">Sucursal</td>
                                <td style="width: 5px;">&nbsp;</td>
                                <td class="tdCentradoVertical" style="width: 275px;">
                                    <asp:HiddenField ID="hdnSucursalDestinoID" runat="server" Visible="False" />
                                    <asp:TextBox ID="txtSucursalDestino" runat="server" MaxLength="80" Width="240px"
                                        AutoPostBack="True" OnTextChanged="txtSucursalDestino_TextChanged"></asp:TextBox>
                                ...
                                <td style="width: 5px;">&nbsp;</td>
                                <td class="tdCentradoVertical">
                                    <asp:TextBox ID="txtEmpresaDestino" runat="server" Width="240px" Enabled="false"></asp:TextBox>
                                    <asp:HiddenField runat="server" ID="hdnEmpresaDestinoID" />
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top: 5px; text-align: right; width: 75px;">Domicilio</td>
