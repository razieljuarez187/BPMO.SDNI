<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="RegistrarAltaUnidadUI.aspx.cs" Inherits="BPMO.SDNI.Flota.UI.RegistrarAltaUnidadUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">FLOTA - ALTA DE UNIDAD</asp:Label>
        </div>
            ...
            <div id="BarraHerramientas">
                <asp:Menu runat="server" ID="mFlota" IncludeStyleBlock="False" Orientation="Horizontal"
                    ...
                    <Items>
                        ...
                        <asp:MenuItem Text="Movimientos" Value="Movimientos" Selected="True" NavigateUrl="#">
                        </asp:MenuItem>
        ...
        <div id="DatosCatalogo" class="GroupBody">
            <div id="EncabezadoDatosCatalogo" class="GroupHeader">
                <asp:Label ID="lblTituloPaso" runat="server" Text="ALTA DE UNIDAD"></asp:Label>
