<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="RegistrarReactivacionUnidadUI.aspx.cs" Inherits="BPMO.SDNI.Flota.UI.RegistrarReactivacionUnidadUI" %>
<%--Satisface los requerimientos especificados en el caso de uso CU082 – REGISTRAR MOVIMIENTO DE FLOTA--%>
<%--Satisface la solicitud de cambio SC0006 (A traves del presenter)--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">FLOTA - REACTIVAR UNIDAD</asp:Label>
        </div>
