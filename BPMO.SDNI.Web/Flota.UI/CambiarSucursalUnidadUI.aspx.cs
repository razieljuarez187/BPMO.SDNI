...
{
    public partial class CambiarSucursalUnidadUI : System.Web.UI.Page, ICambiarSucursalUnidadVIS
    {
        #region Atributos
        /// <summary>
        /// Presentador de la página
        /// </summary>
        private CambiarSucursalUnidadPRE presentador = null;
        /// <summary>
        /// Nombre de la clase que se usará para los mensajes de error
        /// </summary>
        private const string nombreClase = "CambiarSucursalUnidadUI";
        /// <summary>
        /// Enumeración para el manejo del buscador
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                this.presentador = new CambiarSucursalUnidadPRE(this);
        ...
        public int? SucursalActualID
        {
            ...
            set { this.hdnSucursalActualID.Value = value.HasValue ? value.Value.ToString() : string.Empty; }
        }
        /// <summary>
        ...
        {
            get { return this.txtSucursalActual.Text.Trim().ToUpper(); }
            set
            {
                this.txtSucursalActual.Text = !string.IsNullOrEmpty(value) && !string.IsNullOrWhiteSpace(value)
                                                  ? value.Trim().ToUpper()
                                                  : string.Empty;
            }
        }
        ...
        {
            get { return this.txtDomicilioSucursalActual.Text.Trim().ToUpper(); }
            set
            {
                this.txtDomicilioSucursalActual.Text = !string.IsNullOrEmpty(value) && !string.IsNullOrWhiteSpace(value) ? value.Trim().ToUpper() : string.Empty;
            }
        }
        /// <summary>
        ...
        {
            get { return this.txtEmpresaActual.Text.Trim().ToUpper(); }
            set
            {
                this.txtEmpresaActual.Text = !string.IsNullOrEmpty(value) && !string.IsNullOrWhiteSpace(value)
                                                 ? value.ToUpper().Trim()
                                                 : string.Empty;
            }
        }
        ...
        public int? SucursalDestinoID
        {
            ...
            {
                int val = 0;
                if (int.TryParse(this.hdnSucursalDestinoID.Value, out val))
                    return val;
                return null;
            }
            set
            {
                this.hdnSucursalDestinoID.Value = value.HasValue ? value.ToString() : string.Empty;
            }
        }
        /// <summary>
        /// Obtiene o establece el nombre de la sucursal destino
        /// </summary>
        public string NombreSucursalDestino
        {
            get { return this.txtSucursalDestino.Text.Trim().ToUpper(); }
            set
            {
                this.txtSucursalDestino.Text = !string.IsNullOrEmpty(value) && !string.IsNullOrWhiteSpace(value) ? value.Trim().ToUpper() : string.Empty;
            }
        }
        /// <summary>
        /// Obtiene o establece el domicilio de la unidad destino
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el identificador de la empresa destino
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el nombre de la empresa destino
        /// </summary>
        public string EmpresaDestinoNombre
        {
            get { return this.txtEmpresaDestino.Text.Trim().ToUpper(); }
            set
            {
                this.txtEmpresaDestino.Text = !string.IsNullOrEmpty(value) && !string.IsNullOrWhiteSpace(value)
                                                  ? value.Trim().ToUpper()
                                                  : string.Empty;
            }
        }
        ...
        protected void txtSucursalDestino_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string nombreSucursal = NombreSucursalDestino;
                this.Session_BOSelecto = null;

                this.DesplegarBOSelecto(ECatalogoBuscador.Sucursal);

                NombreSucursalDestino = nombreSucursal;
                if (NombreSucursalDestino != null)
                {
                    this.EjecutaBuscador("SucursalSeguridad", ECatalogoBuscador.Sucursal);
                    NombreSucursalDestino = null;
                }
            }
            catch (Exception ex)
            {
