...
namespace BPMO.SDNI.Contratos.PSL.UI {
    public partial class EditarContratoROCUI : System.Web.UI.Page, IEditarContratoROCVIS {
        #region Atributos
        /// <summary>
        /// Presentador de la página de edición
        /// </summary>
        private EditarContratoROCPRE presentador;
        /// <summary>
        /// Nombre de la página que  se esta desplegando
        /// </summary>
        private const string nombreClase = "EditarContratoROCUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                presentador = new EditarContratoROCPRE(this, this.ucInformacionGeneralPSL, this.ucCatalogoDocumentos, this.ucHerramientas, this.ucLineaContratoPSLUI);
                if (!Page.IsPostBack) {
        ...
        public void LimpiarSesion() {
            if (Session["UltimoObjetoContratoROC"] != null)
                Session.Remove("UltimoObjetoContratoROC");
        }
