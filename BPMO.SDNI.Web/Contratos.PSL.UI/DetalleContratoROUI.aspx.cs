...
namespace BPMO.SDNI.Contratos.PSL.UI {
    public partial class DetalleContratoROUI : Page, IDetalleContratoROVIS {
        #region Atributos
        /// <summary>
        /// Presentador de la página de registro
        /// </summary>
        private DetalleContratoROPRE presentador;
        /// <summary>
        /// Nombre de la página que  se esta desplegando
        /// </summary>
        private const string nombreClase = "DetalleContratoROUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                presentador = new DetalleContratoROPRE(this, this.ucInformacionGeneralPSL, this.ucCatalogoDocumentos, this.ucLineaContratoPSLUI, this.ucHerramientas);
                if (!Page.IsPostBack) {
                    presentador.ValidarAcceso();
                    presentador.RealizarPrimeraCarga();
                }
                ucInformacionGeneralPSL.MostrarControlesROC(false);
                ...
                this.ucHerramientas.ImprimirContratoRO = ImprimirContrato_Click;
                this.ucHerramientas.ImprimirPagareRO = ImprimirPagareRO_Click;
        ...
        public void RedirigirAEdicion(bool lEnCurso) {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.PSL.UI/EditarContratoROUI.aspx" + (lEnCurso ? "?S=1" : "")));
        }
        ...
        public void RedirigirARenovar() {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.PSL.UI/RenovarContratoROUI.aspx"));
        }
        ...
        protected void btnRenovar_Click(object sender, EventArgs e) {
            try {
                ...
                this.MostrarMensaje("Inconsistencia al cambiar a Renovar", ETipoMensajeIU.ERROR, nombreClase + ".btnRenovar_Click:" + ex.Message);
            }
        }
        ...
        protected void ImprimirContrato_Click(object sender, EventArgs e) {
            try {
                presentador.ImprimirContratoRO();
            } catch (Exception ex) {
        ...
        /// <param name="sender">Objeto que dispara el evento</param>
        /// <param name="e">parámetros del evento</param>
        protected void ImprimirPagareRO_Click(object sender, EventArgs e) {
            try {
                presentador.ImprimirPagareRO();
            }
            catch (Exception ex) {
                MostrarMensaje("Inconsistencias al imprimir el Pagaré.", ETipoMensajeIU.ERROR, nombreClase + ".ImprimirPagareRO_Click: " + ex.Message);
            }
        }
