<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucResumenContratoPSLUI.ascx.cs"
    Inherits="BPMO.SDNI.Contratos.PSL.UI.ucResumenContratoPSLUI" %>
<%-- 
...
<table class="trAlinearDerecha" style="margin-bottom: 5px; width:100%;">
    ...
    <tr>
        ...
        <td class="tdCentradoVertical" align="right" style="width: 165px;"><asp:Label runat="server" ID="lblFechaCierreContrato">Fecha Cierre de Contrato</asp:Label></td>
        <td style="width: 20px;">&nbsp;</td>
        <td class="tdCentradoVertical" style="width: 320px;">
