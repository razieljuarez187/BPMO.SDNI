<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarContratoROCUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.PSL.UI.RegistrarContratoROCUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
            ...
            initChild = function () {
                <%=ucInformacionGeneralPSL.ClientID %>_Inicializar();
            };
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - REGISTRAR CONTRATO DE RENTA CON OPCI&Oacute;N A COMPRA</asp:Label>
        </div>
            ...
            <asp:View ID="vwContrato" runat="server">
                <div id="divInformacionGeneral" class="GroupBody">
                    <div id="divInformacionGeneralHeader" class="GroupHeader">
                        <span>Contrato DE RENTA con Opci&Oacute;n a Compra</span>
