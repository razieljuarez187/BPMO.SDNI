...
namespace BPMO.SDNI.Contratos.PSL.UI {
    public partial class EditarContratoROUI : System.Web.UI.Page, IEditarContratoROVIS {
        #region Atributos
        /// <summary>
        /// Presentador de la página de edición
        /// </summary>
        private EditarContratoROPRE presentador;
        /// <summary>
        /// Nombre de la página que  se esta desplegando
        /// </summary>
        private const string nombreClase = "EditarContratoROUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                presentador = new EditarContratoROPRE(this, this.ucInformacionGeneralPSL, this.ucCatalogoDocumentos, this.ucHerramientas, this.ucLineaContratoPSLUI);
                if (!Page.IsPostBack) {
                    //Se valida el acceso a la vista
                    this.presentador.ValidarAcceso();
                    String Valor = Request.QueryString["S"];
                    if (Valor != null && Valor == "1") {
                        presentador.RealizarPrimeraCarga(true);
                    } else {
                        presentador.RealizarPrimeraCarga(false);
                    }
                }
        ...
        public void PrepararEdicion(bool lEditarEnCurso) {
            this.btnGuardarPrevio.Visible = !lEditarEnCurso;
            this.btnTerminoPrevio.Text = lEditarEnCurso ? "Guardar" : "Terminar";
            this.ucLineaContratoPSLUI.ModoRegistro = lEditarEnCurso ? "EDEC" : "";
        }
