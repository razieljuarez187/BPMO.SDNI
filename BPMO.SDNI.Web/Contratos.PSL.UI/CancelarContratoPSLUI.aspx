<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" 
    AutoEventWireup="true" CodeBehind="CancelarContratoPSLUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.PSL.UI.CancelarContratoPSLUI" %>
    
<%-- Satisface al Caso de Uso CU013 - Cerrar Contrato de Renta Diaria--%>
<%@ Register Src="ucResumenContratoPSLUI.ascx" TagName="ucResumenContratoPSLUI" TagPrefix="uc" %>
    ...
    <div id="PaginaContenido">
        ...
        <div style="height: 80px;">
            ...
            <ul id="MenuSecundario" style="float: left; height: 64px;">
                <li class="MenuSecundarioSeleccionado">
                    <asp:HyperLink ID="hlConsulta" runat="server" NavigateUrl="~/Contratos.PSL.UI/ConsultarContratoROUI.aspx">
                        CONSULTAR P.S.L.
                        <img id="imgConsultaCatalogo" src="<%= Page.ResolveUrl("~/Contenido/Imagenes/SelectorBlanco.png") %>" alt="selección" /> 
                    </asp:HyperLink>
                </li>
                <li>
                    <asp:HyperLink ID="hlkRegistro" runat="server" NavigateUrl="~/Contratos.PSL.UI/RegistrarContratoROCUI.aspx">
                        REGISTRAR RENTA PSL 
        ...
        <div id="divInformacionGeneral" class="GroupBody">
		    ...
		    <div id="divInformacionGeneralControles">
			    <!--espacio uc información contrato -->
                <uc:ucResumenContratoPSLUI ID="ucResumenContratoPSL" runat="server" />
			</div>
		</div>
        <div class="GroupBody">
