<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Contenido/MasterPages/Site.Master" CodeBehind="ConsultarContratoROCUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.PSL.UI.ConsultarContratoROCUI" %>
<%@ Register src="ucHerramientasPSLUI.ascx" tagname="ucHerramientasPSLUI" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - Consultar RENTA CON OPCIÓN A COMPRA</asp:Label>
        </div>
        <div style="height: 80px;">
            <!-- Menú secundario -->
            <ul id="MenuSecundario" style="float: left; height: 64px;">
                <li class="MenuSecundarioSeleccionado">
                    <asp:HyperLink ID="hlConsultar" runat="server" NavigateUrl="~/Contratos.PSL.UI/ConsultarContratoROCUI.aspx">
                        CONSULTAR R.O.C.
                        <img id="imgConsultaCatalogo" src="<%= Page.ResolveUrl("~/Contenido/Imagenes/SelectorBlanco.png") %>" alt="selección" /> 
                    </asp:HyperLink>
                </li>
                <li>
                    <asp:HyperLink ID="hlRegistroOrden" runat="server" NavigateUrl="~/Contratos.PSL.UI/RegistrarContratoROCUI.aspx">
                        REGISTRAR R.O.C.
        ...
        <div id = "Formulario" class = "GroupSection">
            <div id="EncabezadoDatosCatalogo" class="GroupHeaderCollapsable">
                <table>
                    <tr>
                        <td>
                            ¿QUÉ CONTRATO DE RENTA CON OPCIÓN A COMPRA QUIERE CONSULTAR?
                        </td>
                        <td>
