<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="RenovarContratoROCUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.PSL.UI.RenovarContratoROCUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - RENOVAR CONTRATO DE RENTA CON OPCI&Oacute;N A COMPRA</asp:Label>
        </div>
