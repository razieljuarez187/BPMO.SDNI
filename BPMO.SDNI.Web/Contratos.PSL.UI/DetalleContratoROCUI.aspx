<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="DetalleContratoROCUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.PSL.UI.DetalleContratoROCUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - DETALLE CONTRATO DE RENTA CON OPCI&Oacute;N A COMPRA</asp:Label>
        </div>
            ...
            <asp:View ID="vwContrato" runat="server">
                <div id="divInformacionGeneral" class="GroupBody">
                    <div id="divInformacionGeneralHeader" class="GroupHeader">
                        <span>Contrato DE RENTA con Opción a Compra</span>
