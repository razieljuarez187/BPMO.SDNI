...
namespace BPMO.SDNI.Contratos.PSL.UI {
    public partial class RegistrarContratoROUI : Page, IRegistrarContratoROVIS {
        #region Atributos
        /// <summary>
        /// Presentador de la página de registro
        /// </summary>
        private RegistrarContratoROPRE presentador;
        /// <summary>
        /// Nombre de la página que  se esta desplegando
        /// </summary>
        private const string nombreClase = "RegistrarContratoROUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                presentador = new RegistrarContratoROPRE(this, this.ucInformacionGeneralPSL, this.ucCatalogoDocumentos, this.ucLineaContratoPSLUI);
                if (!Page.IsPostBack)
