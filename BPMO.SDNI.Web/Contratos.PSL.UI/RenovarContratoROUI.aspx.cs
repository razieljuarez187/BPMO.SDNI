...
namespace BPMO.SDNI.Contratos.PSL.UI {
    public partial class RenovarContratoROUI : System.Web.UI.Page, IRenovarContratoROVIS {
        #region Atributos
        /// <summary>
        /// Presentador de la página de edición
        /// </summary>
        private RenovarContratoROPRE presentador;
        /// <summary>
        /// Nombre de la página que  se esta desplegando
        /// </summary>
        private const string nombreClase = "RenovarContratoROUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                presentador = new RenovarContratoROPRE(this, this.ucInformacionGeneralPSL, this.ucCatalogoDocumentos, this.ucHerramientas, this.ucLineaContratoPSLUI);
                if (!Page.IsPostBack) {
