...
namespace BPMO.SDNI.Flota.Reportes.UI {
    ...
    /// </summary>
    public partial class FlotaActivaUI : ReportPage, IFlotaActivaVIS {
        ...
        /// </summary>
        private static readonly String nombreClase = typeof(FlotaActivaUI).Name;
        #endregion
        ...
        /// </summary>
        private FlotaActivaPRE presentador;
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)  {
            this.presentador = new FlotaActivaPRE(this);
            if (!this.IsPostBack) {
