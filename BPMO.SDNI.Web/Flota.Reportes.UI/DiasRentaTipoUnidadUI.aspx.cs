...
{
    /// <summary>
    /// Vista de consulta para el Reporte de Días de Renta por Tipo de Unidad
    /// </summary>
    public partial class DiasRentaTipoUnidadUI : ReportPage, IDiasRentaVIS
    {
        #region Constantes
        /// <summary>
        /// Nombre de la clase en curso
        /// </summary>
        private static readonly String nombreClase = typeof(DiasRentaTipoUnidadUI).Name;
        #endregion
