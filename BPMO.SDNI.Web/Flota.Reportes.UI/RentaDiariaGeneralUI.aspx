<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Reportes.Master" AutoEventWireup="true" CodeBehind="RentaDiariaGeneralUI.aspx.cs" Inherits="BPMO.SDNI.Flota.Reportes.UI.RentaDiariaGeneralUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="encabezadoLeyenda" runat="server">
    <asp:Label ID="lblEncabezadoLeyenda" runat="server">REPORTES - Reporte de Renta Diaria General</asp:Label>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="encabezadoFiltrosReporte" runat="server">
    ...
    ¿Qué filtros desea utilizar para aplicar en el Reporte General de Renta Diaria?
</asp:Content>
