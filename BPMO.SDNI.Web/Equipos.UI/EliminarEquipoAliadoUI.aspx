<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EliminarEquipoAliadoUI.aspx.cs" Inherits="BPMO.SDNI.Equipos.UI.EliminarEquipoAliadoUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">UNIDADES - ELIMINAR EQUIPO ALIADO</asp:Label>
        </div>
			...
			<div id="BarraHerramientas" style="float: right;">
                <asp:Menu runat="server" ID="mnuEquipoAliado" IncludeStyleBlock="False" Orientation="Horizontal" CssClass="MenuPrimario" >
                    <Items>
                        ...
                        <asp:MenuItem Text="Eliminar" Value="Editar" Selected="true" NavigateUrl="#"></asp:MenuItem>
                    </Items>
                    <StaticItemTemplate>
        ...
        <div id="DatosCatalogo" class="GroupBody">
            <div id="EncabezadoDatosCatalogo" class="GroupHeader">
                ...
                <div class="GroupHeaderOpciones Ancho2Opciones">
                    <asp:Button ID="btnGuardar" runat="server" Text="Confirmar" CssClass="btnWizardTerminar" ValidationGroup="Obligatorios" onclick="btnGuardar_Click"/>                    
