<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucHerramientasSDUI.ascx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.SD.UI.ucHerramientasSDUI" %>
...
<div class="BarraNavegacionExtra">  
    <input id="btnNuevoConsulta" type="button" value="Nueva Consulta" onclick="window.location='<%= Page.ResolveUrl("~/Contratos.Mantto.SD.UI/ConsultarContratoSDUI.aspx") %>'" />
