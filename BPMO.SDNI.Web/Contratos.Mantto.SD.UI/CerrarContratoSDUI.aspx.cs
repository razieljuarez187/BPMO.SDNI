...
{
    public partial class CerrarContratoSDUI : System.Web.UI.Page, ICerrarContratoManttoVIS
    {
        #region Atributos
        /// <summary>
        /// Nombre  de la clase para agregar a los mensajes de Error
        /// </summary>
        private const string nombreClase = "CerrarContratoSDUI";

        /// <summary>
        /// Presentador para Cerrar Contrato Mantto
        /// </summary>
        private CerrarContratoManttoPRE presentador;
        ...
        public object UltimoObjeto
        {
            get
            {
                if (Session["UltimoObjetoContratoSD"] != null)
                    return Session["UltimoObjetoContratoSD"];
                return null;
            }
            set
            {
                Session["UltimoObjetoContratoSD"] = value;
            }
        }
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                presentador = new CerrarContratoManttoPRE(this, this.ucHerramientas, this.ucContratoUI,
                    this.ucContratoUI);
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    //Se prepara la página para el cierre
            ...
            {
                this.MostrarMensaje("Inconsistencias al presentar la información.", ETipoMensajeIU.ERROR,
        ...
        #region Métodos
        public void DeshabilitarBotonCerrar()
        {
            this.btnGuardarPrevio.Disabled = true;
        }
        /// <summary>
        /// Indica si el campo Observación de cierre es obligatoria
        /// </summary>
        public void ObservacionObligatoria(bool esObligatorio)
        {
            if (esObligatorio) lblObservaciones.Text = "*";
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/CerrarContratoSDUI.aspx"));
        }
        /// <summary>
        ...
        {
            this.Response.Redirect(ResolveUrl("~/Contratos.Mantto.SD.UI/DetalleContratoSDUI.aspx"),true);
        }
        ...
        {
            if (Session["UltimoObjetoContratoSD"] != null)
                Session.Remove("UltimoObjetoContratoSD");
        }
        /// <summary>
