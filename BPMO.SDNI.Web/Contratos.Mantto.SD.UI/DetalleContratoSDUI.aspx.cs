...
//Satisface al caso de uso CU096 - Imprimir Pagaré SD
...
{
    public partial class DetalleContratoSDUI : System.Web.UI.Page, IDetalleContratoManttoVIS
    {
        #region Atributos
        ...
        /// </summary>
        private string nombreClase = "DetalleContratoSDUI";
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/EditarContratoSDUI.aspx"));
        }
        /// <summary>
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/AgregarDocumentosContratoUI.aspx"));
        }
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/CancelarContratoSDUI.aspx"));
        }
        /// <summary>
        ...
        public void LimpiarSesion()
        {
            ...
            //TODO: La sesión del lastobject no? UltimoObjetoContratoSD
        }
