<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarContratoSDUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.SD.UI.ConsultarContratoSDUI" %>
<%--Satisface al caso de uso CU029 - Consultar Contratos de mantenimiento --%>
<%@ Register src="ucHerramientasSDUI.ascx" tagname="ucHerramientasSDUI" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - CONSULTAR CONTRATO DE SERVICIO DEDICADO</asp:Label>
        </div>
        <div style="height: 80px;">
            ...
            <uc1:ucHerramientasSDUI ID="ucHerramientas" runat="server" />
        </div>
        ...
        <div id="Formulario" class = "GroupSection">
            <div id="EncabezadoDatosCatalogo" class="GroupHeaderCollapsable">
                <table>
                    <tr>
                        <td>¿QUÉ CONTRATO DE SERVICIO DEDICADO QUIERE CONSULTAR?</td>
                        <td>
