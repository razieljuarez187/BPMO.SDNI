...
{
    public partial class CancelarContratoSDUI : System.Web.UI.Page, ICancelarContratoManttoVIS
    {
        #region Atributos
        /// <summary>
        /// Nombre  de la clase para agregar a los mensajes de Error
        /// </summary>
        private const string nombreClase = "CancelarContratoSDUI";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                presentador = new CancelarContratoManttoPRE(this, this.ucHerramientas, this.ucContratoUI,
                    this.ucContratoUI);
