...
{
    public partial class EditarContratoSDUI : System.Web.UI.Page, IEditarContratoManttoVIS
    {
        #region Atributos
        /// <summary>
        ...
        /// </summary>
        private const string nombreClase = "EditarContratoSDUI";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    //Asignamos el identificador del user control de documentos
        ...
        public int? TipoContrato
        {
            get
            {
                return this.ucucContratoManttoUI.TipoContratoID.HasValue ? this.ucucContratoManttoUI.TipoContratoID.Value : (int)ETipoContrato.SD;
            }
        ...
        /// <summary>
        /// Habilita o deshabilita la opción de borrador
        /// </summary>
        ...
        /// <summary>
        /// Habilita o deshabilita la opción de termiando
        /// </summary>
        /// <param name="status">Estatus del control</param>
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/DetalleContratoSDUI.aspx"), false);
        }
        /// <summary>
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Contratos.Mantto.SD.UI/ConsultarContratoSDUI.aspx"), false);
        }
        /// <summary>
