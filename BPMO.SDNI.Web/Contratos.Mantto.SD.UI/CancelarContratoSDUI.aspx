<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="CancelarContratoSDUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.Mantto.SD.UI.CancelarContratoSDUI" %>

<%@ Register Src="~/Contratos.Mantto.UI/ucContratoManttoUI.ascx" TagPrefix="uc" TagName="ucContrato" %>
<%@ Register Src="~/Contratos.Mantto.SD.UI/ucHerramientasSDUI.ascx" TagPrefix="uc"
    TagName="HerramientasSDUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">OPERACI&Oacute;N - CANCELAR CONTRATO DE SERVICIO DEDICADO</asp:Label>
        </div>
        ...
        <div style="height: 80px;">
            ...
            <ul id="MenuSecundario" style="float: left; height: 64px;">
                <li class="MenuSecundarioSeleccionado">
                    <asp:HyperLink ID="hlConsulta" runat="server" NavigateUrl="~/Contratos.Mantto.SD.UI/ConsultarContratoSDUI.aspx">
                        CONSULTAR S.D.
            ...
            <uc:HerramientasSDUI ID="ucHerramientas" runat="server" />
        </div>
        <div id="divInformacionGeneral" class="GroupBody">
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                ...
                <div class="GroupHeaderOpciones Ancho2Opciones">
                    <input type="button" class="btnWizardGuardar" value="Cancelar" id="btnGuardarPrevio"
