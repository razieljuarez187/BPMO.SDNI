...
{
    public partial class DetalleAutorizadorUI : System.Web.UI.Page, IDetalleAutorizadorVIS
    {
        #region Atributos

        private string nombreClase = "DetalleAutorizadorUI";
        private DetalleAutorizadorPRE presentador;
        ...
        public int? AutorizadorID
        {
            ...
            set
            {
                ...
                TextBox txtAutorizadorID = this.mAutorizador.Controls[0].FindControl("txtValue") as TextBox;
        ...
        public bool? Estatus
        {
            ...
            set 
            {
                ...
                TextBox txtEstatus = this.mAutorizador.Controls[2].FindControl("txtValue") as TextBox;
        ...
        {
            set { this.ucAutorizador.UsuarioCreacion = value; }
        }
        public string UsuarioEdicion
        {
            set { this.ucAutorizador.UsuarioEdicion = value; }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                this.presentador = new DetalleAutorizadorPRE(this, this.ucAutorizador);
        ...
        {
            this.Response.Redirect(this.ResolveUrl("~/Comun.UI/EditarAutorizadorUI.aspx"));
        }
        ...
        public void PermitirEditar(bool permitir)
        {
            ...
            this.mAutorizador.Items[1].Enabled = permitir;
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MostrarMensaje("Inconsistencias al intentar editar el autorizador", ETipoMensajeIU.ERROR, nombreClase + ".btnEditar_Click:" + ex.Message);
            }
        }

        protected void mAutorizador_MenuItemClick(object sender, System.Web.UI.WebControls.MenuEventArgs e)
        {
            try
            {
                switch (e.Item.Value)
            ...
            {
                this.MostrarMensaje("Inconsistencias al intentar editar el autorizador", ETipoMensajeIU.ERROR, nombreClase + ".mAutorizador_MenuItemClick:" + ex.Message);
            }
        }
        #endregion
    }
