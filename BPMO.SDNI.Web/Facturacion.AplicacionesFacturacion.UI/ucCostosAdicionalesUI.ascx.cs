...
namespace BPMO.SDNI.Facturacion.AplicacionesFacturacion.UI
{
    ...
    /// </summary>
    public partial class ucCostosAdicionalesUI : System.Web.UI.UserControl, IucCostosAdicionalesVIS
    {
        #region Constantes
        /// <summary>
        ...
        /// </summary>
        private string nombreClase = "ucCostosAdicionalesUI";
        ...
        /// </summary>
        private ucCostosAdicionalesPRE presentador;
        ...
        /// </summary>
        public ucCostosAdicionalesUI()
        {
            this.presentador = new ucCostosAdicionalesPRE(this);
        ...
        {
            string hiddenFieldValue = this.Request.Form[ucCostosAdicionalesUI.PAGEGUIDINDEX];
            ...
            ScriptManager.RegisterHiddenField(this.Page, ucCostosAdicionalesUI.PAGEGUIDINDEX, hiddenFieldValue);
        }
        ...
        private void EjecutaBuscador(string catalogo, ECatalogoBuscador catalogoBusqueda) {
            ...
            this.RegistrarScript("Events", "BtnBuscarCostos('" + ViewState_Guid + "','" + catalogo + "');");
        }
        /// <summary>
