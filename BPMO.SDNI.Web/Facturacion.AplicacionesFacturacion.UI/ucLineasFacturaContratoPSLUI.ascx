<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucLineasFacturaContratoPSLUI.ascx.cs" 
    Inherits="BPMO.SDNI.Facturacion.AplicacionesFacturacion.UI.ucLineasFacturaContratoPSLUI" %>
