...
namespace BPMO.SDNI.Facturacion.AplicacionesFacturacion.UI {
    ...
    /// </summary>
    public partial class ucLineasFacturaUI : System.Web.UI.UserControl, IucLineasFacturaVIS {
        #region Atributos
        /// <summary>
        /// Nombre de la clase en la cual estamos trabajando
        /// </summary>
        private string nombreClase = "ucLineasFacturaUI";

        /// <summary>
        /// Presentador asociado a la vista
        /// </summary>
        private ucLineasFacturaPRE presentador;
        ...
        public void MostrarLineasContrato(IList<DetalleTransaccionBO> detalles) {
            if (detalles != null) {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                this.presentador = new ucLineasFacturaPRE(this);
