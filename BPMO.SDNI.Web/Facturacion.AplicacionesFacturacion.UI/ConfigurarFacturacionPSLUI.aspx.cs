...
namespace BPMO.SDNI.Facturacion.AplicacionesFacturacion.UI {
    /// <summary>
    /// Forma que realiza el proceso de configuración, generación y envÍo de factura
    /// </summary>
    public partial class ConfigurarFacturacionPSLUI : System.Web.UI.Page, IConfigurarFacturacionPSLVIS {
        #region Constantes
        /// <summary>
        ...
        /// </summary>
        private ConfigurarFacturacionPSLPRE presentador;


        public ETipoContrato? TipoPagoContrato {
            get {
                return null;
            }
        }
        ...
        /// </summary>
        private string nombreClase = "ConfigurarFacturacionPSLUI";
        #endregion
        ...
        protected String PaginaConsultaNueva {
            get {
                String url = this.Request[ConfigurarFacturacionPSLUI.PAGINA_CONSULTA_NUEVA];
        ...
        public int? PagoContratoID {
            get {
                ...
                if (this.Request[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO_ID] != null &&
                   int.TryParse(this.Request[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO_ID], out result)) {
                    this.Session[nombreSession] = result;
                    return result;
                }

                if (this.Session[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO] is PagoContratoPSLBO) {
                    PagoContratoPSLBO pago = (PagoContratoPSLBO)this.Session[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO];
                    this.Session[nombreSession] = pago.PagoContratoID;
                    return pago.PagoContratoID;
                }
        ...
        public ETipoContrato? TipoPagoUnidadContrato {
            get {
                ...
                if (this.Session[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO] is PagoContratoPSLBO) {
                    var pago = (PagoContratoPSLBO)this.Session[ConfigurarFacturacionPSLUI.PAGO_UNIDAD_CONTRATO];
                    result = pago.ReferenciaContrato.TipoContratoID;
                    if (pago.GetType() == typeof(PagoContratoPSLBO))
                        result = ((PagoContratoPSLBO)pago).TipoContrato;
                    else {
                        if (pago.GetType() == typeof(PagoContratoPSLBO))
                            result = ((PagoContratoPSLBO)pago).TipoContrato;
                        else {
        ...
        public PagoContratoPSLBO PagoActual {
            get {

                string nombreSession = String.Format("PAGO_{0}", this.ViewState_Guid);

                return (PagoContratoPSLBO)this.Session[nombreSession];
            }
            set {
                string nombreSession = String.Format("PAGO_{0}", this.ViewState_Guid);
                if (value != null)
        ...
        public IucCostosAdicionalesFacturaContratoVIS CostosAdicionalesView {
            get { return this.ucCostosAdicionalesFacturaContratoUI; }
        }
        ...
        /// </summary>
        /// <value>Objeto de tipo IucInformacionCabeceraPSLVIS</value>
        public IucInformacionGeneralPSLVIS InformacionCabeceraView {
            get { return this.ucInformacionGeneralPSLUI; }
        }
        ...
        public IucLineasFacturaContratoPSLVIS LineasFacturaView {
            get { return this.ucLineasFacturaContratoPSLUI; }
        }
        ...
        /// <summary>
        /// Obtiene o establece un valor que representa la dirección del cliente
        /// </summary>
        /// <value>Objeto de tipo String</value>
        ...
        public PagoContratoPSLBO PagoContrato {
            get {
                return (PagoContratoPSLBO)Session["PagoContrato"];
            }

            set {
                Session["PagoContrato"] = value;
            }
        }

        public ContratoPSLBO Contrato {
            get {
                return (ContratoPSLBO)Session["Contrato"];
            }

            set {
                Session["Contrato"] = value;
            }
        }
        ...
        /// <summary>
        /// Identificador del pago de unidad en el grid
        /// </summary>
        public int? PagoUnidadContratoID {
            get { return (int)Session["PagoUnidadContratoID"]; }
            set { Session["PagoUnidadContratoID"] = value; }
        }

        public string ViewState_Guid {
            get {
                if (this.hdnGUID.Value != null && this.hdnGUID.Value != "")
                    return this.hdnGUID.Value;
        ...
        /// </summary>
        public string EnvioFactura {
            get { return this.hdnEnvioFactura.Value; }
            set { this.hdnEnvioFactura.Value = value; }
        }
        /// <summary>
        /// Obtiene el identificador del UsoCFDI
        /// </summary>
        public int? UsoCFDIID {
            get { return this.ucLineasFacturaContratoPSLUI.UsoCFDIId; }
        }
        /// <summary>
        /// Obtiene la clave del UsoCFDI
        /// </summary>
        public string ClaveUsoCFDI {
            get { return this.ucLineasFacturaContratoPSLUI.ClaveUsoCFDI; }
        }
        /// <summary>
        /// Obtiene la descripción del UsoCFDI
        /// </summary>
        public string DescripcionUsoCFDI {
            get { return this.ucLineasFacturaContratoPSLUI.DescripcionUsoCFDI; }
        }
        #endregion
        ...
        private void RegisterGuid() {
            string hiddenFieldValue = this.Request.Form[ConfigurarFacturacionPSLUI.PAGEGUIDINDEX];
            ...
            ScriptManager.RegisterHiddenField(this, ConfigurarFacturacionPSLUI.PAGEGUIDINDEX, hiddenFieldValue);
        }
        ...
        /// <summary>
        /// Establece si se permite capturar datos dentro de una factura
        /// </summary>
        /// <param name="habilitar">Valor booleano para establecer el comportamiento, true para , false para denegar</param>
        public void PertimirCapturar(bool habilitar) {
            this.ucLineasFacturaContratoPSLUI.Enabled = habilitar;
        }
        ...
        /// </summary>
        /// <param name="ocultar">Valor booleano para establecer el comportamiento, true para ocultar, false para visualizar</param>
        public void OcultarAnterior(bool ocultar) {
            this.btnAnterior.Visible = !ocultar;
        }
        ...
        /// </summary>
        /// <param name="ocultar">Valor booleano para establecer el comportamiento, true para ocultar, false para visualizar</param>
        public void OcultarCancelar(bool ocultar) {
            this.btnCancelar.Visible = !ocultar;
        }
        ...
        public void PrepararNuevo() {
            ...
            this.ucInformacionGeneralPSLUI.PrepararNuevo();
            this.ucLineasFacturaContratoPSLUI.PrepararNuevo();
        ...
        protected void Page_Load(object sender, EventArgs e) {
            try {
                this.presentador = new ConfigurarFacturacionPSLPRE(this, this.ucInformacionGeneralPSLUI, this.ucCostosAdicionalesFacturaContratoUI);

                if (!this.IsPostBack) {
                    this.presentador.ValidarAcceso();
                    this.presentador.PrepararNuevo();
                }
                ucInformacionGeneralPSLUI.VerDetalleCargoAdicionalContrato = VerCargoAdicional_Click;
                ucInformacionGeneralPSLUI.ActualizarDescripcionHoraLineaPago = ActualizarDescripcionHoraLinea_Click;
                ucInformacionGeneralPSLUI.CambioMonedaPagoContrato = ucCostosAdicionalesUI_MonedaChanged;
                ucCostosAdicionalesFacturaContratoUI.CancelarClick = CerrarCargoAdicionalContrato_Click;
                ucCostosAdicionalesFacturaContratoUI.GuardarClick = GuardarCargoAdicionalContrato_Click;
            } catch (Exception ex) {
        ...
        /// <param name="sender">Objeto que desencadeno el evento</param>
        /// <param name="e">Argumento asociados al evento</param>
        protected void ucInformacionGeneralPSLUI_FormaPagoChanged(object sender, EventArgs e) {
            try {
                this.presentador.ValidarFormaPago();
            } catch (Exception ex) {
                this.MostrarMensaje("Inconsistencia al cambiar de forma de pago", ETipoMensajeIU.ERROR, this.nombreClase + ".ucInformacionCabeceraPSLUI_FormaPagoChanged:" + ex.Message);
            }
        }
        ...
        protected void CerrarCargoAdicionalContrato_Click(object sender, EventArgs e) {
            try {
                presentador.PrepararVistaCargoFactura();
            } catch (Exception ex) {
        ...
        /// <param name="sender">Objeto que dispara el evento</param>
        /// <param name="e">parámetros del evento</param>
        protected void GuardarCargoAdicionalContrato_Click(object sender, EventArgs e) {
            try {
                presentador.GuardarVistaCargoFactura();
            } catch (Exception ex) {
                MostrarMensaje("Inconsistencias al cancelar la asignación de la unidad al contrato.", ETipoMensajeIU.ERROR, nombreClase + ".CancelarLineaContrato_Click: " + ex.Message);
            }
        }
        ...
        /// <param name="e"></param>
        protected void VerCargoAdicional_Click(object sender, CommandEventArgs e) {
            try {
                var linea = Convert.ToInt32(e.CommandArgument);
                presentador.PrepararVistaCargoAdicional(linea);
            } catch (Exception ex) {
        ...
        /// </summary>
        public void CambiarCapturarFactura() {
            this.mvCU005.ActiveViewIndex = 0;
            this.EncabezadoDatosCatalogo.Visible = true;
        }

        /// <summary>
        /// Cambia la la Vista de la interfaz a la información de la línea contrato
        /// </summary>
        public void CambiarCapturarCargo(int PagoUnidadContratoID) {
            this.PagoUnidadContratoID = PagoUnidadContratoID; //Se guarda en sesión el valor del id seleccionado
            this.mvCU005.ActiveViewIndex = 2;
            this.EncabezadoDatosCatalogo.Visible = false;
        }
        ...
        protected void btnResultCostos_Click(object sender, EventArgs e) {
            try {
                ViewState_Catalogo = ECatalogoBuscador.ProductoServicio;
        ...
        private void DesplegarBOSelecto(ECatalogoBuscador catalogo) {
            presentador.DesplegarInfoBusqueda(catalogo.ToString(), this.Session_BOSelecto);
            this.Session_BOSelecto = null;
        }


        /// <summary>
        /// Método disparado desde el evento evento AgregarClick del Control ucLineaContratoPSLUI
        /// </summary>
        /// <param name="sender">Objeto que dispara el evento</param>
        /// <param name="e">parámetros del evento</param>
        protected void ActualizarDescripcionHoraLinea_Click(object sender, EventArgs e) {
            try {
                int detPagoId = this.InformacionCabeceraView.pagoIdGrid;
                string tipoActualiza = this.InformacionCabeceraView.tipoLinea;
                string DescripcionGrid = Convert.ToBase64String(Encoding.UTF8.GetBytes(this.InformacionCabeceraView.DescripcionMotivoLinea.Trim()));
                presentador.ActualizaDescripcionLineaPago(detPagoId, tipoActualiza, DescripcionGrid);
            } catch (Exception ex) {
                MostrarMensaje("Inconsistencias al cancelar la asignación de la unidad al contrato.", ETipoMensajeIU.ERROR, nombreClase + ".CancelarLineaContrato_Click: " + ex.Message);
            }
        }
