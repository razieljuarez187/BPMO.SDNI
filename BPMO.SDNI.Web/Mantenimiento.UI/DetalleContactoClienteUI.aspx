<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="DetalleContactoClienteUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.DetalleContactoClienteUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .Ancho2Opciones {min-width:270px !important; width:auto;}
    </style>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
			<asp:Label ID="lblEncabezadoLeyenda" runat="server">MANTENIMIENTO - DETALLE CONTACTO CLIENTE</asp:Label>
		</div>
        ...
        <div id="divInformacionGeneral" class="GroupBody" >
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                <span>DETALLE CONTACTO CLIENTE</span>
