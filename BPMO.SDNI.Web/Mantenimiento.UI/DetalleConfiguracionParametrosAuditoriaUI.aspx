<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="DetalleConfiguracionParametrosAuditoriaUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.DetalleConfiguracionParametrosAuditoriaUI" %>
...
<div id="PaginaContenido">
 <!-- Barra de localización -->
        <div id="BarraUbicacion">
            <asp:Label ID="lblEncabezadoLeyenda" runat="server">MANTENIMIENTO - DETALLE CONFIGURACIÓN AUDITORÍA</asp:Label>
        </div>
        ...
        <div style="height: 80px;">
			...
			<div id="BarraHerramientas" style="float: right;">
                <asp:Menu runat="server" ID="mnuConfiguracionMantenimiento" IncludeStyleBlock="False" Orientation="Horizontal" CssClass="MenuPrimario"  OnMenuItemClick="menuSelecionado_MenuItemClick">
                    <Items>
                       <%-- <asp:MenuItem Text="Parametro Configuracion ID" Value="ParametroConfiguracionID" Enabled="False" Selectable="false"></asp:MenuItem>--%>
                        ...
                        <asp:MenuItem Text="Reactivar" Value="ActivarConfiguracion" Enabled="false" ></asp:MenuItem>
                    </Items>
                   <%-- <StaticItemTemplate>
                        <asp:Label runat="server" ID="lblOpcion" CssClass='<%# (string) Eval("Value") == "ParametroConfiguracionID" ? "Informacion" : string.Empty %>' Text='<%# Eval("Text") %>'></asp:Label>
                        <asp:TextBox runat="server" ID="txtValue" Visible='<%# (string) Eval("Value") == "ParametroConfiguracionID" %>' Style="width: 100px" CssClass="textBoxDisabled" ReadOnly="true"></asp:TextBox>
                    </StaticItemTemplate>--%>
        ...
        <div id="divInformacionGeneral" class="GroupBody">
            <div id="divInformacionGeneralHeader" class="GroupHeader">
             <span>DETALLE CONFIGURACIONES AUDITORÍA</span>
                <div class="GroupHeaderOpciones Ancho2Opciones">           
                    <asp:Button ID="btnEditar" runat="server" Text="Editar" CssClass="btnWizardEditar" onclick="btnEditar_Click"/>
                    <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="btnWizardCancelar" onclick="btnRegresar_Click"/>
                </div>
             </div>
                   ...
                   <asp:HiddenField ID="hdnConfiguracionID" runat="server" Visible="False" />
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td class="input-space-responsive">&nbsp;</td>
                        <td class="tdCentradoVertical input-group-responsive">
                            <asp:TextBox ID="txtAleatorias" runat="server" CssClass="CampoNumeroEntero" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>             
                </table>
                    ...
                    <Columns>
                         <asp:TemplateField HeaderText="&nbsp;&nbsp;Actividades&nbsp;&nbsp;">
                          ...
                          <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbCriterioActividad" runat="server" Text=""></asp:Label>
                            </ItemTemplate  >
                             <HeaderStyle HorizontalAlign="Center" Width="40%"/>
                             <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:TemplateField>        
