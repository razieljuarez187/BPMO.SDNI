<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarContactoClienteUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.EditarContactoClienteUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function confirmarEliminarDetalle(mensaje) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
			<asp:Label ID="lblEncabezadoLeyenda" runat="server">MANTENIMIENTO - EDITAR CONTACTO CLIENTE</asp:Label>
		</div>
		...
		<div style="height: 80px;">
			...
			<div id="BarraHerramientas" style="width:100%">
				<asp:Menu runat="server" ID="mContactoCliente" IncludeStyleBlock="False" Orientation="Horizontal"
                    ...
                    <Items>
                        <asp:MenuItem Text="Editar" Value="EditarContactoCliente" Selected="true" NavigateUrl="#"></asp:MenuItem>
						<asp:MenuItem Text="Eliminar" Value="EliminarContactoCliente"></asp:MenuItem>
                    </Items>
                    <LevelSubMenuStyles>
        ...
        <div id="divInformacionGeneral" class="GroupBody" >
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                <span>EDITAR CONTACTO CLIENTE</span>
                <div class="GroupHeaderOpciones Ancho2Opciones">
                    <asp:Button ID="btnEditar" runat="server" Text="Guardar" CssClass="btnWizardGuardar" OnClick="btnFinalizar_Click"/>
