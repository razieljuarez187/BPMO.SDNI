<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarConfiguracionSistemaUnidadUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.EditarConfiguracionSistemaUnidadUI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
			<asp:Label ID="lblEncabezadoLeyenda" runat="server">EDITAR CONFIGURACI&Oacute;N DE SISTEMA DE UNIDAD</asp:Label>
		</div>
		...
		<div style="height: 80px;">
			...
			<div id="BarraHerramientas" style="width:100%">
				<asp:Menu runat="server" ID="mConfiguracion" IncludeStyleBlock="False" Orientation="Horizontal"
                    ...
                    <Items>
                        <asp:MenuItem Text="Editar" Value="EditarConfiguracion" Selected="true"></asp:MenuItem>
        ...
        <div id="divInformacionGeneral" class="GroupBody" >
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                <span>EDITAR CONFIGURACI&Oacute;N DE SISTEMA DE UNIDAD</span>
