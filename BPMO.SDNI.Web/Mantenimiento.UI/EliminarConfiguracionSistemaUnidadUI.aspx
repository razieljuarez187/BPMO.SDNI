<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EliminarConfiguracionSistemaUnidadUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.EliminarConfiguracionSistemaUnidadUI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
			<asp:Label ID="lblEncabezadoLeyenda" runat="server">ELIMINAR CONFIGURACI&Oacute;N DE SISTEMA DE UNIDAD</asp:Label>
		</div>
			...
			<div id="BarraHerramientas" style="width:100%">
				<asp:Menu runat="server" ID="mConfiguracion" IncludeStyleBlock="False" Orientation="Horizontal"
                    ...
                    <Items>
						...
						<asp:MenuItem Text="Eliminar" Value="EliminarConfiguracion" Selected="true"></asp:MenuItem>
                    </Items>
                    <LevelSubMenuStyles>
        ...
        <div id="divInformacionGeneral" class="GroupBody" >
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                <asp:Label ID="spanTituloInformacionGeneral" runat="server">ELIMINAR CONFIGURACI&Oacute;N DE SISTEMA DE UNIDAD</asp:Label>
