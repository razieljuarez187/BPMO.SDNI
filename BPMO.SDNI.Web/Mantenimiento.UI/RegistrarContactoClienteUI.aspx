<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarContactoClienteUI.aspx.cs" Inherits="BPMO.SDNI.Mantenimiento.UI.RegistrarContactoClienteUI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="PaginaContenido">
        ...
        <div id="BarraUbicacion">
			<asp:Label ID="lblEncabezadoLeyenda" runat="server">REGISTRAR CONTACTO CLIENTE</asp:Label>
		</div>
        ...
        <div id="divInformacionGeneral" class="GroupBody" >
            <div id="divInformacionGeneralHeader" class="GroupHeader">
                <span>REGISTRAR CONTACTO CLIENTE</span>
