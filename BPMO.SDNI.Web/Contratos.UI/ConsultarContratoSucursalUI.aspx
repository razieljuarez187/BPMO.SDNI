<%@ Page Title="" Language="C#" MasterPageFile="~/Contenido/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="ConsultarContratoSucursalUI.aspx.cs" Inherits="BPMO.SDNI.Contratos.UI.ConsultarContratoSucursalUI" %>
            ...
            <div id="EncabezadoDatosCatalogo" class="GroupHeaderCollapsable">
                <table>
                    <tr>
                        <td>
                            <label>
                                ¿QU&Eacute; CONTRATO PARA CAMBIAR DE SUCURSAL DESEA CONSULTAR?</label>
                        </td>
                        <td>
