...
namespace BPMO.SDNI.Contratos.PSL.RPT
{
    ...
    /// </summary>
    public partial class RentaDiariaGeneralMesSucursalElementoPSLRPT : DevExpress.XtraReports.UI.XtraReport
    {
        #region Propiedades
        /// <summary>
        ...
        /// </summary>
        public RentaDiariaGeneralMesSucursalElementoPSLRPT()
        {
            InitializeComponent();
        }
