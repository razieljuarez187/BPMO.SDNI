...
namespace BPMO.SDNI.Contratos.FSL.RPT
{
    public partial class AnexoARPT : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void ImprimirReporte(Dictionary<String, Object> dicContratoFSL, XmlDocument xmlDocument)
        {
            ...
            XmlNodeList xmlNota = xmlDocument.GetElementsByTagName("Nota");
            numeroContrato = dicContratoFSL.ContainsKey("NumeroContrato") ? dicContratoFSL["NumeroContrato"].ToString() : "NO ENCONTRADO";
            var content = xmlCabecera[0].InnerText;

            content = content.Replace("{NUMERO_CONTRATO}", numeroContrato);

            xrrchEncabezadoAnverso.Html = content;
            xrrchTxtNota.Html = xmlNota[0].InnerText;
            ...
            #endregion
            this.DtlAnexoAAnverso.DataSource = dicContratoFSL["unidadesContrato"];
            this.xrtbltxtFechaIni.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "FechaInicio");
            this.xrtblTxtTerminoContrato.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "TerminoContrato");
            this.xrtblTxtAnio.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "Anio");
            this.xrtblTxtMarcaUnidad.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "MarcaUnidad");
            this.xrtblTxtModeloTipo.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "ModeloTipo");
            this.xrtblTxtNumSerie.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "NumeroSerie");
            this.xrtblTxtPbvMax.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "PBVMax");
            this.xrtblTxtPesoAuto.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "PesoAutorizado");
            this.xrtblTxtCargoMes.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "CargoFijoMes");
            this.xrtblTxtKmIncluido.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "KmIncluido");
            this.xrtblTxtPeriodoKmIncluido.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "PeriodoKmIncluido");
            this.xrtblTxtCargoKg.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "CargoKilometro");
            this.xrtblTxtCargoKg.Multiline = true;
            this.xrtblTxtCargoKg.CanGrow = true;
            this.xrtblTxtCargoKg.WordWrap = true;
            this.xrtblTxtHrsIncluidas.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "HrsIncluidas");
            this.xrtblTxtPeriodoHrsIncluidas.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "PeriodoHrsIncluidas");
            this.xrtblTxtCargoHra.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "CargoHoraRefrigerada");
            this.xrtblTxtCargoHra.Multiline = true;
            this.xrtblTxtCargoHra.CanGrow = true;
            this.xrtblTxtCargoHra.WordWrap = true;

            this.DtlAnexoAAnversoOC.DataSource = dicContratoFSL["unidadesCompra"];
            this.xrtblOCFilaContent.DataBindings.Add("Text", this.DtlAnexoAAnversoOC.DataSource, "UnidadCompra");
