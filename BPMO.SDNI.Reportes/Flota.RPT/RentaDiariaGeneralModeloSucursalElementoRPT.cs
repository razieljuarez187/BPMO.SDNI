...
namespace BPMO.SDNI.Flota.RPT
{
    ...
    /// </summary>
    public partial class RentaDiariaGeneralModeloSucursalElementoRPT : DevExpress.XtraReports.UI.XtraReport
    {
        #region Propiedades
        /// <summary>
        ...
        /// </summary>
        public RentaDiariaGeneralModeloSucursalElementoRPT()
        {
            InitializeComponent();
        }
        ...
        private void Detail_BeforePrint(object sender, PrintEventArgs e)
        {
            ...
            ReporteRDSucursalDS data = this.DataSource as ReporteRDSucursalDS;
        ...
        private void GroupFooter1_BeforePrint(object sender, PrintEventArgs e)
        {
            ...
            List<ReporteRDSucursalDS.SubTotalXModeloRow> lista = sucursal != 0 ? data.SubTotalXModelo.Where(x => x.Mes == mes && x.SucursalID == sucursal).ToList() : data.SubTotalXModelo.Where(x => x.Mes == mes).ToList();
            ...
            RentaDiariaGeneralSucursalModeloRPT reporte = (this.sbrptTotalesMes.ReportSource = new RentaDiariaGeneralSucursalModeloRPT()) as RentaDiariaGeneralSucursalModeloRPT;
