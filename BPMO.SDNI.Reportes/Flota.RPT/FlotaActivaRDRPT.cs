...
namespace BPMO.SDNI.Flota.RPT
{
    ...
    /// </summary>
    public partial class FlotaActivaRDRPT : DevExpress.XtraReports.UI.XtraReport
    { 
        /// <summary>
        /// Contructor de la plantilla
        /// </summary>
        /// <param name="datos">Datos para llenado de reporte</param>
        public FlotaActivaRDRPT(Dictionary<string, object> datos)
            : this()
        {            
        ...
        /// <param name="sender">Objeto que genero el evento</param>
        /// <param name="e">Argumentos asociados al evento</param>
        private void flotaActivaRDSucursalesRPT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (this.flotaActivaRDSucursalesRPT.ReportSource == null)
                return;

            this.flotaActivaRDSucursalesRPT.ReportSource.DataSource = this.DataSource;
            int modeloID = this.GetCurrentColumnValue<int>("ModeloID");
            this.flotaActivaRDSucursalesRPT.ReportSource.FilterString = String.Format("[ModeloID] = {0}", modeloID);            
        }
        ...
        /// <param name="sender">Objeto que genero el evento</param>
        /// <param name="e">Argumentos asociados al evento</param>
        private void flotaActivaRDSucursalTotalesRPT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (this.flotaActivaRDSucursalTotalesRPT.ReportSource != null)
                this.flotaActivaRDSucursalTotalesRPT.ReportSource.DataSource = this.DataSource;            
        }
