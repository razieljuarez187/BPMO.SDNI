...
{
    /// <summary>
    /// Plantilla de Reporte Porcentaje Utilización de Renta Diaria por Tipo de Unidad
    /// </summary>
    public partial class DiasRentaTipoUnidadRPT : DevExpress.XtraReports.UI.XtraReport
    {
        /// <summary>
        /// Contructor por default
        /// </summary>
        public DiasRentaTipoUnidadRPT()
        {
        ...
        public DiasRentaTipoUnidadRPT(Dictionary<string, object> datos)
            : this()
        {
            ...
            {
                this.xrTableCell5.Text = "REPORTE DE DÍAS DE RENTA POR TIPO DE UNIDAD: " + ((BPMO.SDNI.Flota.Reportes.DA.ReporteRDSucursalDS)(datos["DataSource"])).Sucursales[0].Nombre;
            }
            else { this.xrTableCell5.Text = "REPORTE DE DÍAS DE RENTA POR TIPO DE UNIDAD"; }
        }
        ...
        {
            DiasRentaElementoGraficaModeloRPT subReport = this.xsbrptChartDetails.ReportSource as DiasRentaElementoGraficaModeloRPT;
        ...
        private void xsbrptChartDetails_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            DiasRentaElementoGraficaModeloRPT subReport = report.ReportSource as DiasRentaElementoGraficaModeloRPT;
