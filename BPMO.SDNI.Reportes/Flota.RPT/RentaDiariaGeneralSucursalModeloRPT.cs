...
namespace BPMO.SDNI.Flota.RPT
{
    ...
    /// </summary>
    public partial class RentaDiariaGeneralSucursalModeloRPT : DevExpress.XtraReports.UI.XtraReport
    {
        #region Propiedades
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public RentaDiariaGeneralSucursalModeloRPT()
        {
            InitializeComponent();
        ...
        private void ModificarGrafica(int mes, int sucursalId, ReporteRDSucursalDS datos, int diasMes, List<Int32> totalFlota, List<Int32> totalRentados)
        {
            ...
            if(sucursalId == 0)
            {
                ReporteRDSucursalDS newDataSet = new ReporteRDSucursalDS();
        ...
        private void grpFTotales_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if(sucursal != 0)
            {
                List<ReporteRDSucursalDS.SubTotalXDiaRow> listaDias = data.SubTotalXDia.Where(x => x.Mes == mes && x.SucursalID == sucursal.Value).ToList();
