...
namespace BPMO.SDNI.Contratos.Mantto.CM.RPT
{
	public partial class PagareRPT : DevExpress.XtraReports.UI.XtraReport
	{
		...
		private const string xmlFirmas = "BPMO.SDNI.Reportes.Contrato.Mantto.CM.Firmas.xml";
		private const string xmlPagare = "BPMO.SDNI.Reportes.Contrato.Mantto.CM.Pagare.xml";
		...
		public void ImprimirPagare()
		{
			...
			string sCantidadLetras = enletras(cantidad, sMoneda.ToUpper() );
			#region titulo
		...
		private static string ATexto(decimal value)
		{
            ...
            else if (value < 1000000) Num2Text = ATexto(Math.Truncate(value / 1000)) + " MIL " + (((value % 1000) > 0) ? ATexto(value % 1000) : string.Empty);//SC_0051
