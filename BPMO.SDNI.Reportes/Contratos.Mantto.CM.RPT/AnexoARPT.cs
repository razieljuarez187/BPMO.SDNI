...
namespace BPMO.SDNI.Contratos.Mantto.CM.RPT
{
    ...
    {
        #region Atributos
        public static string NombreArchivo = "BPMO.SDNI.Reportes.Anexo.A.CM.xml";
        ...
        public void ImprimirReporte(Dictionary<String, Object> dicContrato, XmlDocument xmlDocument)
        {
            ...
            this.xrtblTxtCargoKg.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource, "CargoKilometro", "{0:###,##0.00##} " + codigoMonedaContrato + " +IVA"); //, "{0:###,##0.00##} " + codigoMonedaContrato + " +IVA");|"CargoKilometro"
            ...
            this.xrtblTxtCargoHra.DataBindings.Add("Text", this.DtlAnexoAAnverso.DataSource,"CargoHoraRefrigerada", "{0:###,##0.00##} " + codigoMonedaContrato + " +IVA"); //, "{0:###,##0.00##} " + codigoMonedaContrato + " +IVA");|"CargoHoraRefrigerada"
