...
namespace BPMO.SDNI.Contratos.RD.RPT
{
    ...
    /// </summary>
    public partial class PorcentajeUtilizacionRDTipoUnidadRPT : DevExpress.XtraReports.UI.XtraReport
    {
        /// <summary>
        /// Contructor por default
        /// </summary>
        public PorcentajeUtilizacionRDTipoUnidadRPT()
        {
        ...
        public PorcentajeUtilizacionRDTipoUnidadRPT(Dictionary<string, object> datos)
            : this()
        {
            ...
            {
                this.xrTableCell5.Text = "TIME UTILIZATION POR TIPO DE UNIDAD: " + ((BPMO.SDNI.Flota.Reportes.DA.ReporteRDSucursalDS)(datos["DataSource"])).Sucursales[0].Nombre;
            }
            else { this.xrTableCell5.Text = "TIME UTILIZATION POR TIPO DE UNIDAD"; }
        }
