...
{
    /// <summary>
    /// Plantilla de Reporte detallado de Renta diaria por sucursal
    /// </summary>
    public partial class DetalladoRDSucursalRPT : DevExpress.XtraReports.UI.XtraReport
    {
        /// <summary>
        ...
        public DetalladoRDSucursalRPT(Dictionary<string, object> datos)
            : this()
        {
        ...
        private void InitializeDataCell(XRTableCell cell, double weight, int dayOfMonth, int month, int year, int monthDays)
        {
            ...
            calculatedField.DataMember = "ConsultarDetalladoRDSucursal";
            ...
            cell.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
                new DevExpress.XtraReports.UI.XRBinding("Text", null, String.Format("ConsultarDetalladoRDSucursal.{0}", calculatedField.Name))
            });
        }
        ...
        private void InitializeTotalStatusCell(XRTableCell cell, double weight, int dayOfMonth, int month, int year, int monthDays, EEstatusHistorial? estatus, int level)
        {
            ...
            cell.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
                new DevExpress.XtraReports.UI.XRBinding("Text", null, String.Format("ConsultarDetalladoRDSucursal.EstatusHistorial_{0}", dayOfMonth))
            });
        ...
        /// <param name="sender">Objeto que genero el evento</param>
        /// <param name="e">Argumentos asociados al evento</param>
        private void DetalladoRDSucursalRPT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.CreateNewColumns();

            var rowsConfiguracion = (this.DataSource as ConsultarDetalladoRDSucursalDS).ConfiguracionModulo.ToList();
            ...
            {
                var listaUnidades = (this.DataSource as ConsultarDetalladoRDSucursalDS).ConsultarDetalladoRDSucursal.Count > 0 ? (this.DataSource as ConsultarDetalladoRDSucursalDS).ConsultarDetalladoRDSucursal.ToList() : null;
            ...
            //this.xrSubRptRentados.ReportSource.DataSource = this.DataSource;
            foreach (var parameter in this.Parameters)           
                this.xrSubRptRentados.ReportSource.Parameters[parameter.Name].Value = parameter.Value;            

            DetalladoRDSucursalPromedioMensualRPT reportSource = this.xrSubRptRentados.ReportSource as DetalladoRDSucursalPromedioMensualRPT;
