...
{
	public partial class ContratoSDRPT : DevExpress.XtraReports.UI.XtraReport
	{
		...
		public ContratoSDRPT(Dictionary<string, object> ht, string url)
		{
			try
			{
				InitializeComponent();
		...
		private void ImprimirPersona(Dictionary<string, object> ht)
		{
			...
			path += "BPMO.SDNI.Reportes.Contrato.Mantto.SD.xml";
