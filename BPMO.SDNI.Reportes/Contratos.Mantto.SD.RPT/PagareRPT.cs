...
namespace BPMO.SDNI.Contratos.Mantto.SD.RPT
{
	public partial class PagareRPT : DevExpress.XtraReports.UI.XtraReport
	{
		...
		private const string xmlFirmas = "BPMO.SDNI.Reportes.Contrato.Mantto.SD.Firmas.xml";
		private const string xmlPagare = "BPMO.SDNI.Reportes.Contrato.Mantto.SD.Pagare.xml";
