...
{
    /// <summary>
    /// Vista para la página de reasignación de sucursal para la unidad
    /// </summary>
    public interface ICambiarSucursalUnidadVIS
    {
        #region Propiedades
        /// <summary>
        ...
        #region SucursalDestino
        /// <summary>
        /// Identificador de la sucursal destino
        /// </summary>
        int? SucursalDestinoID { get; set; }
        /// <summary>
        /// Nombre de la sucursal destino
        /// </summary>
        string NombreSucursalDestino { get; set; }
        /// <summary>
        /// Domicilio de la sucursal destino
        /// </summary>
        ...
        /// </summary>
        string EmpresaDestinoNombre { get; set; }
        #endregion
