...
namespace BPMO.SDNI.Facturacion.AplicacionesFacturacion.VIS
{
    ...
    /// </summary>
    public interface IucCostosAdicionalesVIS
    {
        /// <summary>
        ...
        /// <summary>
        /// Regresa el directorio raiz de la aplicación en curso
        /// </summary>
        ...
        /// <summary>
        /// Realiza un llamado al Metodo del Presentador para agregar un costo adicional
        /// </summary>
