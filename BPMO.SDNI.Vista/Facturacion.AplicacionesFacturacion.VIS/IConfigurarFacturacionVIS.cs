...
namespace BPMO.SDNI.Facturacion.AplicacionesFacturacion.VIS
{
    ...
    /// prefactura
    /// </summary>
    public interface IConfigurarFacturacionVIS
    {
        /// <summary>
        ...
        int? PagoUnidadContratoID { get; }

        /// <summary>
        /// Obtiene el Tipo del Pago FSL, CM, RD
        /// </summary>
        ETipoContrato? TipoPagoUnidadContrato { get; }
        ...
        PagoUnidadContratoBO PagoActual { get; set; }
        ...
        IucCostosAdicionalesVIS CostosAdicionalesView { get; }
        ...
        IucInformacionAdicionalVIS InformacionAdicionalView { get; }
        ...
        IucInformacionCabeceraVIS InformacionCabeceraView { get; }
        ...
        IucLineasFacturaVIS LineasFacturaView { get; }        
