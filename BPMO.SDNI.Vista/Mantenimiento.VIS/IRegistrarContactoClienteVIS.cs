...
namespace BPMO.SDNI.Mantenimiento.VIS {
    ...
    /// <summary>
    /// Interface que define las acciones que debe de contener una vista que ejecuta la funcionalidad de Registro del 
    /// Contacto Cliente Idealease.
    /// </summary>
    public interface IRegistrarContactoClienteVIS {
