...
namespace BPMO.SDNI.Mantenimiento.VIS
{
    ...
    /// <summary>
    /// Interface que define las acciones que debe de contener una vista que ejecuta la funcionalidad de Registro, Edición y Eliminado del 
    /// Contacto Cliente Idealease.
    /// </summary>
    public interface IEliminarContactoClienteVIS {
        ...
        /// </summary>
        void RedirigirAConsultaContactoCliente();
