...
using BPMO.SDNI.Contratos.PSL.BO;// <----Cambiar ruta para el BO
...
namespace BPMO.SDNI.Contratos.PSL.VIS {
    ...
    /// </summary>
    public interface IucTarifaPSLVIS {
        #region Propiedades
        /// <summary>
        ...
        /// </summary>
        List<RangoTarifaPSLBO> RangosTarifa { get; set; }
        /// <summary>
        /// Rango Inicial
        /// </summary>
        ...
        void PresentarRangos(List<RangoTarifaPSLBO> rangoTarifa);
